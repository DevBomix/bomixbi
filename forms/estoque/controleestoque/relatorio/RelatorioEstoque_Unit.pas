...
begin
      ...
      if CBX_TipoRelatorio.Text = 'RELATÓRIO DE ESTOQUE - POR PRODUTO' then
      begin
...
begin
      ...
      begin
          ...
          if CBX_TipoRelatorio.Text = 'RELATÓRIO DE ESTOQUE - POR PRODUTO' then
          begin
              LBL_Status.Caption := 'Impressão: ' + DateTimeToStr(Date()) + '  por ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;
              ppImage15.Picture := Sys_FuncaoSistema.Img_LogoBomix.Picture;
              ppReportPorProduto.Print;
          end
          else
          begin
              ppLabel14.Caption := 'Impressão: ' + DateTimeToStr(Date()) + '  por ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;
