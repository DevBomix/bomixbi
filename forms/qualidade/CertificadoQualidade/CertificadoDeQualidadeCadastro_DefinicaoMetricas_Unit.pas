...
begin
    ...
    begin
         Application.MessageBox('Campo Obrigatório: Defina um valor' + #13 + '','Atenção',mb_iconerror + mb_ok);
   ...
   TXT_Encontrado.Text := StringReplace(TXT_Encontrado.Text, '.', ',', [rfReplaceAll, rfIgnoreCase]);
    ...
    begin
          ...
          then
          begin
               Application.MessageBox('Valor definido fora do Padrão (Minimo/Maximo)' + #13 + '','Atenção',mb_iconerror + mb_ok);
               TXT_Encontrado.SetFocus;
               Exit;
          end;
    end;
