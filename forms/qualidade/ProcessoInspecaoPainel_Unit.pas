...
uses
  ...
  Vcl.Grids, Vcl.DBGrids, View.WebCharts, System.DateUtils, Math, Charts.Types, TypInfo;
      ...
      .Rows
          ...
          ._Div
              ...
              .Add('<span class="count_top">' +
                   ...
                   '<span class="count_bottom"> ' +
                   ' média de <i class="green"><i class=""></i>' + FloatToStr(VLN_TurnoTotalMedia) + '</i> inspeções feitas' +
                   '</span> ')
          .&End
