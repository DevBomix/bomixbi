...
begin
  ...
  begin
      Application.MessageBox('Nenhum registro definido!','Atenção',mb_iconwarning + mb_ok);
      Exit;
  end;
  ...
  begin
    ...
    BTN_SemMedida.Caption := 'Sem Medida Padrão Configurada';
  end
  else
  begin
...
begin
  ...
  VLC_Select := VLC_Select + '  AND Finalizado = ' + '''' + 'Não' + '''' + #13;
...
//  VLC_Select := VLC_Select + ' AND Tipo in (' + '''' + 'BALDE' + '''' + ',' + '''' + 'TAMPA' + '''' + ',' + '''' + 'BOMBONA' + '''' + ',' + '''' + 'SUPORTE' + '''' + ',' + '''' + 'ALÇA' + '''' + ')' + #13;
...
begin
  ...
  Try
      ...
      begin
          ...
          Teste_Espessura_NovoTeste_SepararParaTeste.CDS_MedidasGrupo_FK.AsString := CDS_MedidasGrupo_FK.AsString;
          Teste_Espessura_NovoTeste_SepararParaTeste.CDS_MedidasPadrao.AsFloat := CDS_MedidasPadrao.AsFloat;
          Teste_Espessura_NovoTeste_SepararParaTeste.CDS_MedidasVariacao.AsFloat := CDS_MedidasVariacao.AsFloat;
          Teste_Espessura_NovoTeste_SepararParaTeste.CDS_MedidasMaximo.AsFloat := CDS_MedidasMaximo.AsFloat;
          Teste_Espessura_NovoTeste_SepararParaTeste.CDS_MedidasMinimo.AsFloat := CDS_MedidasMinimo.AsFloat;
          Teste_Espessura_NovoTeste_SepararParaTeste.CDS_Medidas.Post;
          CDS_Medidas.Prior;
      end;

      Teste_Espessura_NovoTeste_SepararParaTeste.LBL_Coletado_GrupoID.Caption := LBL_Coletado_GrupoID.Caption;
      Teste_Espessura_NovoTeste_SepararParaTeste.LBL_Coletado_Grupo.Caption := LBL_Coletado_Grupo.Caption;

      Teste_Espessura_NovoTeste_SepararParaTeste.ShowModal;
      Teste_Espessura_NovoTeste.Close;
  Finally
