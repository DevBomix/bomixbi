...
uses ColetaSemanal_Unit, ColetaSemanal_NovaColetaQTD_Unit,
  ColetaSemanal_NovaColeta_FuncionarioBuscador_Unit;
...
begin
  ...
  Try
    ColetaSemanal_NovaColeta_FuncionarioBuscador.ShowModal;
  Finally
    ColetaSemanal_NovaColeta_FuncionarioBuscador.Release;
    ColetaSemanal_NovaColeta_FuncionarioBuscador := nil;
