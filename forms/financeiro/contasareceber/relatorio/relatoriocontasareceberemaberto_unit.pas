...
begin
  ...
  if CBX_MostrarTitulosOcultos.Text = 'NÃO' then
  begin
...
begin
  ...
  if CBX_Tipo.Text = 'POR GERÊNCIA' then  VLC_OrderBy := ' ORDER BY Gerente';
  ...
  begin
     ...
     begin
          ...
          if CBX_VerificarObservacoes.Text = 'SIM' then
           ...
           ppLBL_PeriodoCliente.Caption :=  ' Data de Saída Entre ' + ' ' + DateToStr(DT_DataEmissao1.Date) + ' a ' + DateToStr(DT_DataEmissao2.Date);
           LBL_DataCliente.Caption :=  'Data Impressão: ' + DateTimeToStr(Date());
     ...
     begin
          ...
          if CBX_VerificarObservacoes.Text = 'SIM' then
           ...
           ppLBL_PeriodoBanco.Caption :=  ' Data de Saída Entre ' + ' ' + DateToStr(DT_DataEmissao1.Date) + ' a ' + DateToStr(DT_DataEmissao2.Date);
           LBL_DataBanco.Caption :=  'Data Impressão: ' + DateTimeToStr(Date());
     ...
     begin
          ...
          if CBX_VerificarObservacoes.Text = 'SIM' then
           ...
           ppLBL_PeriodoPorGerencia.Caption :=  ' Data de Saída Entre ' + ' ' + DateToStr(DT_DataEmissao1.Date) + ' a ' + DateToStr(DT_DataEmissao2.Date);
           LBL_DataPorGerencia.Caption :=  'Data Impressão: ' + DateTimeToStr(Date());
