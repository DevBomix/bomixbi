...
begin
  ...
  Panel_ImpressaoCracha.Top := DBGrid.Top;
  Panel_ImpressaoCracha.Left := DBGrid.Left;
  LBL_TipoImpressao.Caption := ' Crachá';
  Panel_ImpressaoCracha.Visible := True;
...
begin
  ...
  Except
       ...
       Application.MessageBox('Arquivo não encontrado em local padrão para armazenar fotos ' +
       'ou alguma informação incompleta no Totvs (Ex: Cargo, Departamento)','Atenção',mb_iconwarning + mb_ok);
  end;
