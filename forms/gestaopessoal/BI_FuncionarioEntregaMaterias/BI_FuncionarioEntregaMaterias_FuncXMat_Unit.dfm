object BI_FuncionarioEntregaMaterias_FuncXMat: TBI_FuncionarioEntregaMaterias_FuncXMat
  OldCreateOrder = False
  Height = 418
  Width = 818
  object ppDBPipeline_EntregaMaterial: TppDBPipeline
    DataSource = DS_EntregaMaterial
    CloseDataSource = True
    UserName = 'DBPipeline_EntregaMaterial'
    Left = 80
    Top = 45
  end
  object ppEntregaMaterial: TppReport
    AutoStop = False
  ...
  object Query_EntregaMaterial: TADOQuery
    ...
    SQL.Strings = (
      #9'Select '
        ...
        ' '#9#9#9'Recno, Funcionario.IDTotvs, Funcionario.Empresa, Funcionario' +
        '.Chapa, Matricula, NomeCompleto as Funcionario, Funcao, TipoFunc' +
      ...
      '    Where 1 = 1 '
        ...
        '    AND DataVencimento Between CONVERT(Datetime,Convert(Varchar(' +
        '10),'#39'01/03/2021'#39',103),103)'
      
        '    AND CONVERT(Datetime,Convert(Varchar(10),'#39'01/04/2021'#39',103),1' +
        '03)'
      
        '  AND Funcionario.Empresa in ('#39#39','#39'BOMIX MATRIZ'#39')  AND Funcionari' +
        'o.Status in ('#39#39','#39'ATIVO'#39')    AND (Rtrim(Matricula) + Rtrim(NomeCo' +
        'mpleto) + Rtrim(Funcao) + Rtrim(TipoFuncao) + Rtrim(Departamento' +
        ') + Isnull(Rtrim(Horario),'#39#39') + Isnull(Rtrim(SituacaoFolha),'#39#39') ' +
        '+ Isnull(Rtrim(Acessorio),'#39#39'))'
      ' Like '#39'%%'#39
      'Order by Empresa, NomeCompleto, Acessorio_FK')
    Left = 152
    Top = 46
    object Query_EntregaMaterialRecno: TIntegerField
      FieldName = 'Recno'
    end
    object Query_EntregaMaterialIDTotvs: TStringField
      FieldName = 'IDTotvs'
      Size = 6
    end
    object Query_EntregaMaterialEmpresa: TStringField
      FieldName = 'Empresa'
      Size = 100
    end
    object Query_EntregaMaterialMatricula: TStringField
      FieldName = 'Matricula'
      Size = 6
    end
    object Query_EntregaMaterialFuncionario: TStringField
      FieldName = 'Funcionario'
      Size = 70
    end
    object Query_EntregaMaterialFuncao: TStringField
      FieldName = 'Funcao'
      Size = 70
    end
    object Query_EntregaMaterialTipoFuncao: TStringField
      FieldName = 'TipoFuncao'
      Size = 200
    end
    object Query_EntregaMaterialDepartamento: TStringField
      FieldName = 'Departamento'
      Size = 60
    end
    object Query_EntregaMaterialAdmissao: TDateTimeField
      FieldName = 'Admissao'
    end
    object Query_EntregaMaterialDemissao: TDateTimeField
      FieldName = 'Demissao'
    end
    object Query_EntregaMaterialHorario: TStringField
      FieldName = 'Horario'
      Size = 50
    end
    object Query_EntregaMaterialSituacaoFolha: TStringField
      FieldName = 'SituacaoFolha'
      Size = 12
    end
    object Query_EntregaMaterialAcessorio_FK: TIntegerField
      FieldName = 'Acessorio_FK'
    end
    object Query_EntregaMaterialAcessorio: TStringField
      FieldName = 'Acessorio'
      Size = 150
    end
    object Query_EntregaMaterialDataEntrega: TDateTimeField
      FieldName = 'DataEntrega'
    end
    object Query_EntregaMaterialDataVencimento: TDateTimeField
      FieldName = 'DataVencimento'
    end
    object Query_EntregaMaterialDataDevolucao: TDateTimeField
      FieldName = 'DataDevolucao'
    end
    object Query_EntregaMaterialQuantidade: TIntegerField
      FieldName = 'Quantidade'
    end
    object Query_EntregaMaterialObservacao: TStringField
      FieldName = 'Observacao'
      Size = 80
    end
    object Query_EntregaMaterialStatus: TStringField
      FieldName = 'Status'
      Size = 15
    end
    object Query_EntregaMaterialChapa: TStringField
      FieldName = 'Chapa'
      Size = 8
    end
  end
  object DS_EntregaMaterial: TDataSource
    DataSet = CDS_EntregaMaterial
    Left = 181
    Top = 46
  end
  object CDS_EntregaMaterial: TClientDataSet
    Aggregates = <>
    FieldDefs = <
      item
        Name = 'Recno'
    ...
    IndexDefs = <>
    Params = <>
    ProviderName = 'DSP_EntregaMaterial'
    StoreDefs = True
    Left = 212
    Top = 46
    object CDS_EntregaMaterialRecno: TIntegerField
      FieldName = 'Recno'
    end
    object CDS_EntregaMaterialIDTotvs: TStringField
      FieldName = 'IDTotvs'
      Size = 6
    end
    object CDS_EntregaMaterialEmpresa: TStringField
      FieldName = 'Empresa'
      Size = 100
    end
    object CDS_EntregaMaterialMatricula: TStringField
      FieldName = 'Matricula'
      Size = 6
    end
    object CDS_EntregaMaterialFuncionario: TStringField
      FieldName = 'Funcionario'
      Size = 70
    end
    object CDS_EntregaMaterialFuncao: TStringField
      FieldName = 'Funcao'
      Size = 70
    end
    object CDS_EntregaMaterialTipoFuncao: TStringField
      FieldName = 'TipoFuncao'
      Size = 200
    end
    object CDS_EntregaMaterialDepartamento: TStringField
      FieldName = 'Departamento'
      Size = 60
    end
    object CDS_EntregaMaterialAdmissao: TDateTimeField
      FieldName = 'Admissao'
    end
    object CDS_EntregaMaterialDemissao: TDateTimeField
      FieldName = 'Demissao'
    end
    object CDS_EntregaMaterialHorario: TStringField
      FieldName = 'Horario'
      Size = 50
    end
    object CDS_EntregaMaterialSituacaoFolha: TStringField
      FieldName = 'SituacaoFolha'
      Size = 12
    end
    object CDS_EntregaMaterialAcessorio_FK: TIntegerField
      FieldName = 'Acessorio_FK'
    end
    object CDS_EntregaMaterialAcessorio: TStringField
      FieldName = 'Acessorio'
      Size = 150
    end
    object CDS_EntregaMaterialDataEntrega: TDateTimeField
      FieldName = 'DataEntrega'
    end
    object CDS_EntregaMaterialDataVencimento: TDateTimeField
      FieldName = 'DataVencimento'
    end
    object CDS_EntregaMaterialDataDevolucao: TDateTimeField
      FieldName = 'DataDevolucao'
    end
    object CDS_EntregaMaterialQuantidade: TIntegerField
      FieldName = 'Quantidade'
    end
    object CDS_EntregaMaterialObservacao: TStringField
      FieldName = 'Observacao'
      Size = 80
    end
    object CDS_EntregaMaterialStatus: TStringField
      FieldName = 'Status'
      Size = 15
    end
    object CDS_EntregaMaterialChapa: TStringField
      FieldName = 'Chapa'
      Size = 8
    end
  end
  object DSP_EntregaMaterial: TDataSetProvider
    DataSet = Query_EntregaMaterial
