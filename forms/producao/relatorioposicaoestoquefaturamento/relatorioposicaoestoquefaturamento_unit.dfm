inherited PosicaoEstoqueFaturamento: TPosicaoEstoqueFaturamento
  Caption = 'Posi'#231#227'o de Estoque x Faturamento'
  ClientHeight = 294
  ClientWidth = 687
  OnCreate = FormCreate
  ExplicitWidth = 693
  ...
  object Panel6: TPanel [5]
    ...
    object CBX_Ordernamento: TComboBox
      Left = 334
      Top = 4
      Width = 322
      Height = 23
      ...
      Items.Strings = (
        'POR PRODUTO ID'
        'POR PRODUTO'
        'POR EMISS'#195'O - CRESCENTE'
        'POR EMISS'#195'O - DECRESCENTE'
        'POR CLIENTE'
        'POR SALDO')
    end
  end
  object Panel9: TPanel [6]
    ...
    ParentBackground = False
    TabOrder = 6
    object CBX_OperadorDataEntrega: TComboBox
      Left = 196
      Top = 4
      Width = 134
      Height = 23
    ...
    object Panel10: TPanel
      ...
      ParentFont = False
      TabOrder = 1
      object PNL_SinalDataEntrega: TPanel
        Left = 174
        Top = 1
        Width = 13
        Height = 21
    ...
    object CBX_Igual_DataEntrega: TComboBox
      Left = 660
      Top = 4
      Width = 322
      Height = 23
    ...
    object TXT_Valor1_DataEntrega: TMaskEdit
      Left = 334
      Top = 4
      Width = 159
      Height = 23
    ...
    object TXT_Valor2_DataEntrega: TMaskEdit
      Left = 495
      Top = 4
      Width = 160
      Height = 23
    ...
    object DT_DataEntrega1: TDateTimePicker
      Left = 336
      Top = 2
      Width = 323
      Height = 24
  ...
  object CDS: TClientDataSet
    ...
    object CDSPersonalizado: TStringField
    ...
    object CDSF2_Empresa: TStringField
      FieldName = 'F2_Empresa'
      Size = 6
    end
    object CDSUltimaFabricacao: TDateTimeField
      FieldName = 'UltimaFabricacao'
    end
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ''
      ' Select Posicao.*, UltimaDataFabricacao.UltimaFabricacao '
      ' from BomixBI.dbo.Est_TB_PosicaoDeEstoqueXFaturamento Posicao '
      
        ' Inner Join BomixBI.[dbo].[Pcp_TB_Produto_UltimaDataFabricacaoPo' +
        'rLote] UltimaDataFabricacao ON UltimaDataFabricacao.Produto_FK =' +
        ' Posicao.Produto_ID '
      ' AND UltimaDataFabricacao.H6_Empresa = Posicao.F2_Empresa '
      '    Where Emissao <= '#39'2019-09-03 00:00:00'#39
    ...
    object QueryPersonalizado: TStringField
      FieldName = 'Personalizado'
      Size = 3
    end
    ...
    object QueryF2_Empresa: TStringField
      FieldName = 'F2_Empresa'
      Size = 6
    end
    object QueryUltimaFabricacao: TDateTimeField
      FieldName = 'UltimaFabricacao'
    end
