object OrdemSolicitacao_MateriaPrima_RelatorioConferencia: TOrdemSolicitacao_MateriaPrima_RelatorioConferencia
  Left = 0
  Top = 0
  Caption = 'OrdemSolicitacao_MateriaPrima_RelatorioConferencia'
  ClientHeight = 168
  ClientWidth = 435
  Color = clBtnFace
  ...
  object CDS: TClientDataSet
    ...
    Left = 48
    Top = 34
    object CDSOrigem_ID: TStringField
      FieldName = 'Origem_ID'
      Size = 4
    end
    ...
    object CDSSolicitado: TFloatField
      FieldName = 'Solicitado'
      ReadOnly = True
    end
    object CDSEntregue: TFloatField
      FieldName = 'Entregue'
      ReadOnly = True
    end
    ...
    object CDSDocumento: TMemoField
      FieldName = 'Documento'
      ReadOnly = True
      BlobType = ftMemo
    end
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ' Select '
        ...
        '        Origem_ID,  Solicitado.Emissao, Grupo, Solicitado.Produt' +
        'o_FK, Solicitado.Produto, Solicitado.Lote, Solicitado, '
      
        '        Isnull(Entregue,0) as Entregue, Unidade, Isnull(Document' +
        'o,'#39#39') as Documento '
      ' from ( '
      '         Select '
      
        '              Origem_ID, Emissao, Rtrim(B1_BRGRP) as Grupo, Prod' +
        'uto_FK, Rtrim(B1_DESC) as Produto, Lote, Sum(Quantidade) as Soli' +
        'citado, Unidade'
      
        '         from BomixBI.dbo.[Est_TB_EstoqueSolicitacaoMateriaPrima' +
        '] Solicitacao (nolock) '
      
        '         Inner Join BomixBI.dbo.[Est_TB_EstoqueSolicitacaoMateri' +
        'aPrimaItem] Item (nolock) ON Item.Empresa = Solicitacao.Empresa '
      
        '                                                                ' +
        '                AND Item.Solicitacao_FK = Solicitacao.Codigo '
      
        '         Inner Join P12OFICIAL.dbo.SB1010 Produto (nolock) ON Pr' +
        'oduto.D_E_L_E_T_ <> '#39'*'#39
      
        '                                                          AND Pr' +
        'oduto.B1_FILIAL = '#39'0101'#39
      
        '                                                          AND Pr' +
        'oduto.B1_COD = Item.Produto_FK '
      
        '          Where Solicitacao.Emissao = CONVERT(Datetime,Convert(V' +
        'archar(10),'#39'17/10/2019'#39',103),103)'
      '          AND Solicitacao.Origem_ID = '#39'PR'#39
      
        '          Group by Origem_ID, Emissao, B1_BRGRP, Produto_FK, B1_' +
        'DESC, Lote, Unidade '
      ''
      ' ) Solicitado '
      ' Left Join ( '
      ...
      ' '#9#9#9'Select '
        ...
        '   '#9#9#9#9'Emissao, Produto_FK, Produto, Lote, Sum(Quantidade) as En' +
        'tregue, '
      '  '
      ' '#9#9#9'Isnull(Stuff( '
      ' '#9#9#9'( '
      '  '#9#9#9#9'SELECT Distinct '#39' ; '#39' + Rtrim(Documento) '
      
        ' '#9#9#9#9#9'from BomixBI.[dbo].[Est_TB_EstoqueMovimentoDevolucao] Docu' +
        'mento '
      ' '#9#9#9#9#9'Where Documento.Destino_ID = '#39'PR'#39
      
        ' '#9#9#9#9#9'AND Documento.Emissao = CONVERT(Datetime,Convert(Varchar(1' +
        '0),'#39'17/10/2019'#39',103),103)'
      ' '#9#9#9#9#9'AND Documento.Tipo_FK = '#39'DE4'#39
      ' '#9#9#9#9#9'AND Documento.Produto_FK = Movimento.Produto_FK '
      ' '#9#9#9#9'FOR XML PATH('#39#39'),TYPE).value('#39'.'#39','#39'VARCHAR(MAX)'#39'), 1, 2, '#39#39
      ' '#9#9#9#9'),'#39#39') AS Documento '
      '  '
      
        ' '#9#9#9'from BomixBI.[dbo].[Est_TB_EstoqueMovimentoDevolucao] Movime' +
        'nto (nolock) '
      ' '#9#9#9'Where Destino_ID = '#39'PR'#39
      
        ' '#9#9#9'AND Emissao = CONVERT(Datetime,Convert(Varchar(10),'#39'17/10/20' +
        '19'#39',103),103)'
      ' '#9#9#9'AND Tipo_FK = '#39'DE4'#39
      ' '#9#9#9'Group By Emissao, Produto_FK, Produto, Lote '
      '  '
      ' ) Entregue ON Entregue.Produto_FK = Solicitado.Produto_FK '
      #9#9'  AND Entregue.Lote = Solicitado.Lote '#9
      ' '#9#9'  AND Entregue.Emissao = Solicitado.Emissao '
      '  '
      ' Order by Produto_FK, Lote '
      ''
      '')
    Left = 87
    Top = 33
    object QueryOrigem_ID: TStringField
      FieldName = 'Origem_ID'
      Size = 4
    end
    ...
    object QuerySolicitado: TFloatField
      FieldName = 'Solicitado'
      ReadOnly = True
    end
    object QueryEntregue: TFloatField
      FieldName = 'Entregue'
      ReadOnly = True
    end
    ...
    object QueryDocumento: TMemoField
      FieldName = 'Documento'
      ReadOnly = True
      BlobType = ftMemo
    end
  ...
  object ppImpressao: TppReport
    ...
    object ppHeaderBand5: TppHeaderBand
      ...
      object ppLabel33: TppLabel
        ...
        Border.mmPadding = 0
        Caption = 'Confer'#234'ncia de Entrega no Dia: '
    ...
    object ppFooterBand5: TppFooterBand
      ...
      object ppLabel12: TppLabel
        ...
        HyperlinkEnabled = False
        Border.mmPadding = 0
        Caption = 'Impress'#227'o feita por: '
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
