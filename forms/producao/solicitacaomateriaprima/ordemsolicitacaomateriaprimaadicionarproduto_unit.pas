...
begin
  ...
  begin
      Application.MessageBox('Quantidade no Estoque Zerada!','Atenção',mb_iconwarning + mb_ok);
      Exit;
  end;
...
begin
  ...
  VLC_Select := VLC_Select + '     	  B2_QATU as Estoque, Rtrim(B1_UM) as UndMedida, ' + '''' + 'Não' + '''' + ' as TemLote ' + #13;
