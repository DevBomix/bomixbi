object Relatorio_ApontamentoPersonalizacaoAnalitico: TRelatorio_ApontamentoPersonalizacaoAnalitico
  Left = 0
  Top = 0
  Caption = 'Relatorio_ApontamentoPersonalizacaoAnalitico'
  ClientHeight = 349
  ClientWidth = 725
  Color = clBtnFace
  ...
  object Query_Apontamento: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  '
        ...
        'ontamento.DataTurno, DataIni, HoraIni, DataFin, HoraFin,  '
        ...
        ' from BomixBI.dbo.Pcp_TB_OrdemPersonalizacaoApontamentoRelatorio' +
        ' Apontamento (nolock) '
      '  Where Apontamento.Empresa = '#39'0101'#39
      
        ' AND Apontamento.DataTurno Between  CONVERT(Datetime,Convert(Var' +
        'char(10),'#39'29/07/2017 10:10:49'#39',103),103)'
      
        ' AND CONVERT(Datetime,Convert(Varchar(10),'#39'29/07/2017 10:10:49'#39',' +
        '103),103)'
      ' AND rtrim(Apontamento.Area) in ('#39'PERSONALIZACAO'#39')'
      ' AND rtrim(Apontamento.Setor) in ('#39'PERSONALIZACAO'#39')'
      ''
  ...
  object Query_HorasImprodutivas: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  Where Empresa = '#39'0101'#39
        ...
        ' AND DataTurno Between  CONVERT(Datetime,Convert(Varchar(10),'#39'21' +
        '/10/2015 10:10:49'#39',103),103) AND CONVERT(Datetime,Convert(Varcha' +
        'r(10),'#39'21/10/2015 10:10:49'#39',103),103)'
      ' AND rtrim(Setor) = '#39'INJECAO 04'#39
      ' AND Injetora_FK = '#39'380-01'#39
      ' AND Turno = '#39'01'#39
      '  Order by HoraIni ')
    Left = 105
    Top = 93
  ...
  object ppDBPipeline_HorasImprodutivas: TppDBPipeline
    ...
    Left = 39
    Top = 90
    object ppDBPipeline_HorasImprodutivasppField1: TppField
      Alignment = taRightJustify
      FieldAlias = 'Recno'
      FieldName = 'Recno'
      FieldLength = 0
    ...
    object ppDBPipeline_HorasImprodutivasppField2: TppField
      FieldAlias = 'Empresa'
      FieldName = 'Empresa'
      FieldLength = 4
      DisplayWidth = 4
    ...
    object ppDBPipeline_HorasImprodutivasppField3: TppField
      FieldAlias = 'Area'
      FieldName = 'Area'
      FieldLength = 50
      DisplayWidth = 50
    ...
    object ppDBPipeline_HorasImprodutivasppField4: TppField
      FieldAlias = 'Setor'
      FieldName = 'Setor'
      FieldLength = 50
      DisplayWidth = 50
    ...
    object ppDBPipeline_HorasImprodutivasppField5: TppField
      FieldAlias = 'Turno'
      FieldName = 'Turno'
      FieldLength = 2
      DisplayWidth = 2
    ...
    object ppDBPipeline_HorasImprodutivasppField6: TppField
      FieldAlias = 'TurnoDescricao'
      FieldName = 'TurnoDescricao'
      FieldLength = 15
      DisplayWidth = 15
    ...
    object ppDBPipeline_HorasImprodutivasppField7: TppField
      FieldAlias = 'Emissao'
      FieldName = 'Emissao'
      FieldLength = 0
      DataType = dtDateTime
    ...
    object ppDBPipeline_HorasImprodutivasppField8: TppField
      FieldAlias = 'DataTurno'
      FieldName = 'DataTurno'
      FieldLength = 0
      DataType = dtDateTime
    ...
    object ppDBPipeline_HorasImprodutivasppField9: TppField
    ...
    object ppDBPipeline_HorasImprodutivasppField10: TppField
      FieldAlias = 'Injetora'
      FieldName = 'Injetora'
      FieldLength = 30
      DisplayWidth = 30
    ...
    object ppDBPipeline_HorasImprodutivasppField11: TppField
      FieldAlias = 'DataIni'
      FieldName = 'DataIni'
      FieldLength = 0
      DataType = dtDateTime
    ...
    object ppDBPipeline_HorasImprodutivasppField12: TppField
      FieldAlias = 'HoraIni'
      FieldName = 'HoraIni'
      FieldLength = 5
      DisplayWidth = 5
    ...
    object ppDBPipeline_HorasImprodutivasppField13: TppField
      FieldAlias = 'DataFim'
      FieldName = 'DataFim'
      FieldLength = 0
      DataType = dtDateTime
    ...
    object ppDBPipeline_HorasImprodutivasppField14: TppField
      FieldAlias = 'HoraFim'
      FieldName = 'HoraFim'
      FieldLength = 5
      DisplayWidth = 5
    ...
    object ppDBPipeline_HorasImprodutivasppField15: TppField
      FieldAlias = 'Motivo_ID'
      FieldName = 'Motivo_ID'
      FieldLength = 2
      DisplayWidth = 2
      Position = 14
    end
    object ppDBPipeline_HorasImprodutivasppField16: TppField
      FieldAlias = 'Motivo'
      FieldName = 'Motivo'
      FieldLength = 55
      DisplayWidth = 55
    ...
    object ppDBPipeline_HorasImprodutivasppField17: TppField
    ...
    object ppDBPipeline_HorasImprodutivasppField18: TppField
    ...
    object ppDBPipeline_HorasImprodutivasppField19: TppField
      Alignment = taRightJustify
      FieldAlias = 'TempoParada'
      FieldName = 'TempoParada'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
