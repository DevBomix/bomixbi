...
begin
  ...
  begin
     LBL_Periodo.Caption :=  ' Data de Emissão Entre ' + ' ' + DateToStr(Relatorio_ApontamentoPersonalizacao.DT_DataEmissao1.Date) + ' a ' + DateToStr(Relatorio_ApontamentoPersonalizacao.DT_DataEmissao2.Date);
     ppLabel35.Caption := 'Data Impressão: ' + DateTimeToStr(Date()) + ' - ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;
