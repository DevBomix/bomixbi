object Relatorio_ApontamentoProducao_AcompanhamentoVolume: TRelatorio_ApontamentoProducao_AcompanhamentoVolume
  Left = 0
  Top = 0
  Caption = 'ACOMPANHAMENTO DE VOLUME DE PRODU'#199#195'O'
  ClientHeight = 299
  ClientWidth = 635
  Color = clBtnFace
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  '
        ...
        ' '#9'Recurso_ID, Recurso, DataTurno, TurnoDescricao, Cavidade, Capa' +
        'cidadeDisponivel as CapacidadeReal, Producao,   '
      #9'(CapacidadeDisponivel - Producao) as Diferenca'
      '  '
      ' from [dbo].[Pcp_VW_OrdemProducaoApontamentoMIGUEL_Totvs]  '
      
        ' Where DataTurno =  CONVERT(Datetime,Convert(Varchar(10),'#39'17/10/' +
      ...
      'Order by Setor, Recurso_ID desc, Turno  '
      '')
    Left = 75
    Top = 30
    ...
    object QueryProducao: TFloatField
      FieldName = 'Producao'
    end
  ...
  object CDS: TClientDataSet
    ...
    object CDSProducao: TFloatField
      FieldName = 'Producao'
    end
  ...
  object ppRelatorio: TppReport
    ...
    object ppHeaderBand3: TppHeaderBand
      ...
      object ppLabel38: TppLabel
        ...
        Caption = 'Relat'#243'rio de Perdas Sint'#233'tico - Por Motivo'
