...
begin
  ...
  begin
     ppLabel9.Caption :=  ' Data de Emissão Entre ' + ' ' + DateToStr(DT_DataEmissao1.Date) + ' a ' + DateToStr(DT_DataEmissao2.Date);
     ppLabel10.Caption := 'Data Impressão: ' + DateTimeToStr(Date()) + ' - ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;
...
begin
  ...
  begin
     ppLabel20.Caption :=  ' Data de Emissão Entre ' + ' ' + DateToStr(DT_DataEmissao1.Date) + ' a ' + DateToStr(DT_DataEmissao2.Date);
     ppLabel22.Caption := 'Data Impressão: ' + DateTimeToStr(Date()) + ' - ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;
...
//  VLC_Select := VLC_Select + ' 	 (Round(((MinutosTotalDeUmDia * 60)/AVG(CicloPadrao)) * AVG(Cavidade),0) * Dias) as CapacidadeInstalada,' + #13;
  ...
  begin
     ...
     ppLabel29.Caption :=  ' Data de Emissão Entre ' + ' ' + DateToStr(DT_DataEmissao1.Date) + ' a ' + DateToStr(DT_DataEmissao2.Date);
...
begin
      ...
      if CBX_Tipo.Text = 'APONTAMENTOS DE PRODUÇÃO - SINTÉTICO (POR ITEM)' then
      begin
         //DT_DataEmissao2.Date := DT_DataEmissao1.Date;
         Relatorio_ApontamentoProducaoSinteticoPorItem;
      end;

      if CBX_Tipo.Text = 'APONTAMENTOS DE PRODUÇÃO - SINTÉTICO (POR PRODUTO)' then
      begin
         //DT_DataEmissao2.Date := DT_DataEmissao1.Date;
         Relatorio_ApontamentoProducaoSinteticoPorProduto;
      end;

      if CBX_Tipo.Text = 'APONTAMENTOS DE PRODUÇÃO - SINTÉTICO (POR RECURSO)' then
      begin
         // DT_DataEmissao2.Date := DT_DataEmissao1.Date;
         Relatorio_ApontamentoProducaoSinteticoPorRecurso;
      end;

      if CBX_Tipo.Text = 'APONTAMENTOS DE PRODUÇÃO - SINTÉTICO (POR TURNO)' then
      begin
         DT_DataEmissao2.Date := DT_DataEmissao1.Date;
      ...
      if CBX_Tipo.Text = 'ANÁLISE DE OEE (OVERALL EQUIPMENT EFFECTIVENESS)' then
      begin
         DT_DataEmissao2.Date := DT_DataEmissao1.Date;
      ...
      if CBX_Tipo.Text = 'APONTAMENTOS DE PRODUÇÃO - ANALÍTICO' then
      begin
          DT_DataEmissao2.Date := DT_DataEmissao1.Date;
     ...
     {
      if CBX_Tipo.Text = 'ANÁLISE DE PERDAS, EFICIÊNCIA E PRODUTIVIDADE (ANTIGO)' then
      begin
      ...
      if CBX_Tipo.Text = 'ANÁLISE DE PERDAS, EFICIÊNCIA E PRODUTIVIDADE' then
      begin
         Application.CreateForm(TRelatorio_ApontamentoProducao_OEE, Relatorio_ApontamentoProducao_OEE);
...
begin
  ...
  if (CBX_Tipo.Text = 'ANÁLISE DE OEE (OVERALL EQUIPMENT EFFECTIVENESS)')
  OR (CBX_Tipo.Text = 'APONTAMENTOS DE PRODUÇÃO - ANALÍTICO')
  OR (CBX_Tipo.Text = 'ACOMPANHAMENTO DE VOLUME DE PRODUÇÃO') then
  begin
  ...
  inherited;
     ...
     try
        ...
        begin
            ...
            CBX_OperadorGrupoProduto.Text := 'Contém';
...
begin
    ...
    try
        ...
        begin
            ...
            CBX_OperadorOrdemProducao.Text := 'Contém';
...
begin
   ...
   try
        ...
        begin
            ...
            CBX_OperadorProduto.Text := 'Contém';
...
begin
   ...
   try
        ...
        begin
            ...
            CBX_OperadorProdutoID.Text := 'Contém';
...
begin
     ...
     try
        ...
        begin
            ...
            CBX_OperadorInjetoraID.Text := 'Contém';
