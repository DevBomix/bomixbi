...
begin
  ...
  begin
     ...
     ppLabel51.Caption :=  ' Data de Emissão Entre ' + ' ' + DateToStr(Relatorio_ApontamentoProducao.DT_DataEmissao1.Date) + ' a ' + DateToStr(Relatorio_ApontamentoProducao.DT_DataEmissao2.Date);
     ppLabel52.Caption := 'Data Impressão: ' + DateTimeToStr(Date()) + ' - ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;
