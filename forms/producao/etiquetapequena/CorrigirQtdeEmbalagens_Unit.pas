...
begin
  ...
  begin
       Application.MessageBox('Acesso negado para impressão de Pallete.' + #13 + 'Consulte o Administrador do sistema','Atenção',mb_iconwarning + mb_ok);
   end
   else
   begin
...
begin
  ...
  begin
       Application.MessageBox('Acesso negado para impressão de Peça Padrão.' + #13 + 'Consulte o Administrador do sistema','Atenção',mb_iconwarning + mb_ok);
   end
   else
   begin
...
begin
  ...
  begin
       Application.MessageBox('Acesso negado para Imprimir Etiqueta.' + #13 + 'Consulte o Administrador do sistema','Atenção',mb_iconwarning + mb_ok);
   end
   else
   begin
            ...
            begin
                  ...
                  begin
                        ...
                        begin
                            Application.MessageBox('Não é permitido imprimir acima de 30 Etiquetas.!','Atenção',mb_iconwarning + mb_ok);
                            Exit;
                        end;
                  end;
            end;
           ...
           {TODO -oBRITO -cRotina Futura : Recriar Controle de Etiqueta}
            ...
            begin
                  ...
                  begin
                        ...
                        begin
                            Application.MessageBox('Ordem Bloqueada por Tempo para Impressão. Aguarde 15 minutos!','Atenção',mb_iconwarning + mb_ok);
                            Exit;
                        end;
                  end;
            end;
            ...
            begin
                ppReport1Label3.Caption := 'Bomix Divisão Sopro';
                ppLabel3.Caption := 'Bomix Divisão Sopro';
            end;
