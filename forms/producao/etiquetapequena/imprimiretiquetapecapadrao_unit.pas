...
begin
  ...
  VLC_Select := VLC_Select + '     ' + IntToStr(VLN_Recno) + ', C2_Recno, ' + '''' + 'Não' + '''' + ' as Revisao, ' + '''' + CBX_Revisao.Text + '''' + ' as Revisao, Area, ' + #13;
  ...
  VLC_Select := VLC_Select + '     ' + IntToStr(VLN_Recno) + ' as Etiqueta, GetDate() as Data, ' + '''' + 'IMPRESSÃO' + '''' + ' as Tipo,' + #13;
  VLC_Select := VLC_Select + '''' + Sys_FuncaoSistema.PNL_LoginAtivo.Caption + '''' + ' as Usuario, (' + '''' + 'IMPRESSÃO DO PRODUTO: ' + '''' + ' + ProdutoOP_FK) as Ocorrencia' + #13;
...
begin
    ...
    begin
        ...
        begin
            Application.MessageBox('Campo Obrigatório: Defina a Cor do Produto','Atenção',mb_iconwarning + mb_ok);
            TXT_Cor.SetFocus;
            Exit;
        end;
        ...
        begin
            Application.MessageBox('Campo Obrigatório: Defina a Dosagem do Produto','Atenção',mb_iconwarning + mb_ok);
  ...
  begin
      ...
      begin
           Application.MessageBox('Campo Obrigatório: Defina o Codigo do Produto','Atenção',mb_iconwarning + mb_ok);
