object Relatorio_PosicaoEstoque_SaldoPerda: TRelatorio_PosicaoEstoque_SaldoPerda
  Left = 0
  Top = 0
  Caption = 'Relatorio_PosicaoEstoque_SaldoPerda'
  ClientHeight = 299
  ClientWidth = 635
  Color = clBtnFace
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  '
        ...
        #9'Substring(B2_FILIAL,1,4) as Empresa, Armazem.Z1_COD as Armazem_' +
        'FK,   '
      
        #9'Rtrim(Armazem.Z1_COD)  + '#39' - '#39' + Rtrim(Armazem.Z1_DESC) as Arma' +
        'zem,  '
      
        #9'Item_FK, ItemSemTipoAlca as Item, Produto_ID, Produto, Bloquead' +
        'o, '
      
        #9'B2_QATU as Saldo, Produto.UndMedida, B2_QATU * Produto.PesoSemA' +
        'lca as PesoKG, Produto.PesoSemAlca as PesoItem'
      ''
      'from P12OFICIAL.dbo.SB2010 B2 (nolock)'
      'Inner Join ( '
      #9#9#9'Select '
      #9#9#9#9'Distinct B1_FILIAL, B1_FSPRODC'
      #9#9#9'from P12OFICIAL.dbo.SB1010 (nolock)'
      #9#9#9'Where B1_FSPRODC <> '#39#39
      #9#9#9'AND D_E_L_E_T_ <> '#39'*'#39
      #9#9#9'AND B1_FILIAL = '#39'0101'#39
      ') TB ON B2_FILIAL = '#39'010101'#39' '
      #9'AND TB.B1_FSPRODC = B2_COD'
      
        'Inner Join BomixBI.dbo.Pcp_TB_Produto Produto (Nolock) ON Produt' +
        'o.Empresa  = '#39'0101'#39
      '                        '#9#9#9#9#9#9#9'  AND Produto_ID = B2_COD '
      
        'Inner Join P12OFICIAL.dbo.SZ1010 Armazem (nolock) ON Armazem.Z1_' +
        'FILIAL = B2_FILIAL '
      ...
      ''
      'AND Substring(B2_FILIAL,1,4)  = '#39'0101'#39
      'AND Armazem.Z1_COD in ( '
      
        '                         Select Z7_LOCAL from P12OFICIAL.dbo.SZ7' +
        '010 (nolock) '
      '                         Where Z7_FILIAL   = '#39'0101'#39
      '                         AND Z7_CUSERID = '#39'000020'#39
      '                         AND D_E_L_E_T_  <> '#39'*'#39
      '                      )  '
      'AND B2_QATU > 0  '
      ''
      'Order by B2_FILIAL, Armazem.Z1_COD, Item_FK, Produto_ID '
      '')
    Left = 251
    Top = 60
    ...
    object QueryPesoKG: TFloatField
      FieldName = 'PesoKG'
      ReadOnly = True
    end
  ...
  object ppRelatorio: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel9: TppLabel
        ...
        Border.mmPadding = 0
        Caption = 'Saldo em Estoque das Perdas'
