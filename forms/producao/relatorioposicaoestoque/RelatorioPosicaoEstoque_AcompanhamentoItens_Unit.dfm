object Relatorio_PosicaoEstoque_AcompanhamentoItens: TRelatorio_PosicaoEstoque_AcompanhamentoItens
  Left = 0
  Top = 0
  Caption = 'Relatorio_PosicaoEstoque_AcompanhamentoItens'
  ClientHeight = 352
  ClientWidth = 681
  Color = clBtnFace
  ...
  object ppDB: TppDBPipeline
    ...
    object ppDBppField13: TppField
      FieldAlias = 'SaldoTotalB8'
      FieldName = 'SaldoTotalB8'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 12
    ...
    object ppDBppField15: TppField
      FieldAlias = 'PeriodoProdutivo'
      FieldName = 'PeriodoProdutivo'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 14
    ...
    object ppDBppField18: TppField
      FieldAlias = 'StatusValidade'
      FieldName = 'StatusValidade'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 17
    ...
    object ppDBppField19: TppField
      FieldAlias = 'DiasEmEstoque'
      FieldName = 'DiasEmEstoque'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 18
    ...
    object ppDBppField21: TppField
      FieldAlias = 'Desbalanceado'
      FieldName = 'Desbalanceado'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 20
    ...
    object ppDBppField22: TppField
      FieldAlias = 'SaldoNegativo'
      FieldName = 'SaldoNegativo'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 21
  ...
  object CDS: TClientDataSet
    ...
    object CDSSaldoB2: TFloatField
      FieldName = 'SaldoB2'
    end
    object CDSSaldoB8: TFloatField
      FieldName = 'SaldoB8'
    end
    object CDSSaldoTotalB8: TFloatField
      FieldName = 'SaldoTotalB8'
      ReadOnly = True
    end
    ...
    object CDSPeriodoProdutivo: TStringField
      FieldName = 'PeriodoProdutivo'
      ReadOnly = True
      Size = 43
    end
    object CDSDataEstoque: TDateTimeField
      FieldName = 'DataEstoque'
      ReadOnly = True
    end
    ...
    object CDSStatusValidade: TStringField
      FieldName = 'StatusValidade'
      ReadOnly = True
      Size = 8
    end
    object CDSDiasEmEstoque: TIntegerField
      FieldName = 'DiasEmEstoque'
      ReadOnly = True
    end
    ...
    object CDSDesbalanceado: TStringField
      FieldName = 'Desbalanceado'
      ReadOnly = True
      Size = 13
    end
    object CDSSaldoNegativo: TStringField
      FieldName = 'SaldoNegativo'
      ReadOnly = True
      Size = 3
    end
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
        ...
        ' Select *, Cast(SaldoTotalB8 as decimal) - Cast(SaldoB2 as decim' +
        'al) as Diferenca, Case when Cast(SaldoTotalB8 as decimal) - Cast' +
        '(SaldoB2 as decimal) = 0 then '#39#39' else '#39'DESBALANCEADO'#39' end as Des' +
        'balanceado  from ('
      '      Select  '
      
        '      '#9#9'B8.R_E_C_N_O_ as Recno, B8_FILIAL as Empresa, B8_LOCAL a' +
        's Armazem_FK,   '
      
        '      '#9#9'Rtrim(Armazem.Z1_COD) + '#39' - '#39' + Rtrim(Armazem.Z1_DESC) a' +
        's Armazem,  '
      
        '      '#9#9'Item_FK, ItemSemTipoAlca as Item, Rtrim(B8_PRODUTO) as P' +
        'roduto_FK, Produto,  Produto.Bloqueado, B8_LOTECTL as Lote,   '
      
        '      '#9#9'Produto.Classificacao + '#39' - '#39' + Produto.ClassificacaoDes' +
        'c as Classificacao,   '
      
        '       '#9#9'B2_QATU as SaldoB2, B8_SALDO as SaldoB8, Produto.UndMed' +
        'ida, '
      '  '
      #9#9#9'( '
      #9#9#9#9'Select  '
      #9#9#9#9#9'Sum(B8_SALDO) as SaldoTotalB8  '
      #9#9#9#9'from P12OFICIAL.dbo.SB8010 Total_B8 (nolock)  '
      #9#9#9#9'Where Total_B8.B8_FILIAL = '#39'010101'#39
      #9#9#9#9'AND Total_B8.D_E_L_E_T_  <> '#39'*'#39
      #9#9#9#9'AND Total_B8.B8_SALDO <> 0   '
      #9#9#9#9'AND Total_B8.B8_PRODUTO = B8.B8_PRODUTO  '
      #9#9#9#9'AND Total_B8.B8_LOCAL = B8.B8_LOCAL  '
      #9#9#9') as SaldoTotalB8, '
      '   '
      '         '
      '      '#9#9#9#9'Case   '
      '          '
      
        '      '#9#9#9#9#9'when DATEDIFF(Day,(Convert(Datetime,B8_FSDTENT,112)),' +
        'Convert(Datetime,B8_FSDTSAI,112)) = 0 then  '
      
        '       '#9#9#9#9#9#9'Convert(Varchar(10),(Convert(Datetime,B8_DATA,112))' +
        ',103)  '
      '       '#9#9#9#9#9'else   '
      
        '       '#9#9#9#9#9#9#39'De '#39' + Convert(Varchar(10),(Convert(Datetime,B8_DA' +
        'TA,112)),103) + '#39' at'#233' '#39
      
        '       '#9#9#9#9#9#9'+ Convert(Varchar(10),Convert(Datetime,B8_FSDTSAI,1' +
        '12),103) + '#39' .... ('#39
      
        '      '#9#9#9#9#9#9'+ Cast(DATEDIFF(Day,(Convert(Datetime,B8_DATA,112)),' +
        'Convert(Datetime,B8_FSDTSAI,112)) as varchar(5)) '
      '      '#9#9#9#9#9#9'+ '#39' d)'#39
      '           '
      #9#9#9#9'end as PeriodoProdutivo,    '
      '         '
      '       '#9#9'(Convert(Datetime,B8_DATA,112)) as DataEstoque,   '
      '       '#9#9'(Convert(Datetime,B8_DTVALID,112)) as DataValidade,  '
      
        '       '#9#9'Case When (Convert(Datetime,B8_DTVALID,112)) <= GetDate' +
        '() then '#39'VENCIDO'#39' else '#39'NO PRAZO'#39' end StatusValidade, '
      
        '      '#9#9'Case when B8_FSDTSAI = '#39#39' then DATEDIFF(Day,(Convert(Dat' +
        'etime,B8_DATA,112)),GetDate()) else DATEDIFF(Day,(Convert(Dateti' +
        'me,B8_FSDTSAI,112)),GetDate()) end as DiasEmEstoque,  '
      '         '
      '         '
      ' '#9#9#9'Case when (  '
      ' '#9#9#9'Select    '
      ' '#9#9#9#9'Top 1 R_E_C_N_O_   '
      ' '#9#9#9'from P12OFICIAL.dbo.SB8010 (nolock)  '
      ' '#9#9#9'Where B8_FILIAL = '#39'010101'#39
      ' '#9#9#9'AND B8_PRODUTO = B8.B8_PRODUTO  '
      ' '#9#9#9'AND B8_LOCAL = B8.B8_LOCAL  '
      
        ' '#9#9#9'AND B8_SALDO < 0) is NULL then '#39'N'#227'o'#39' else '#39'Sim'#39' end as Saldo' +
        'Negativo '
      '         '
      '         '
      '      from P12OFICIAL.dbo.SB8010 B8 (nolock)  '
      
        '      Inner Join P12OFICIAL.dbo.SB2010 B2 (nolock) ON B2_FILIAL ' +
        '= '#39'010101'#39
      '      '#9#9#9#9#9#9#9#9#9#9#9'  AND B2.D_E_L_E_T_ <> '#39'*'#39
      '      '#9#9#9#9#9#9#9#9#9#9#9'  AND B2_COD = B8_PRODUTO   '
      '      '#9#9#9#9#9#9#9#9#9#9#9'  AND B2_LOCAL = B8_LOCAL   '
      
        '      Inner Join BomixBI.dbo.Pcp_TB_Produto Produto (Nolock) ON ' +
        'Produto.Empresa = '#39'0101'#39
      
        '                              '#9#9#9#9#9#9#9'  AND Produto_ID = B8_PRODU' +
        'TO  '
      
        '      Inner Join P12OFICIAL.dbo.SZ1010 Armazem (nolock) ON Armaz' +
        'em.Z1_FILIAL  = '#39'010101'#39
        ...
        '                                                       AND Armaz' +
        'em.D_E_L_E_T_ <> '#39'*'#39
      '      Where B8.B8_FILIAL = '#39'010101'#39
      '      AND B8.D_E_L_E_T_  <> '#39'*'#39
      '      AND B8_SALDO <> 0   '
      '      AND Z1_COD in ('
      
        '                               Select Z7_LOCAL from P12OFICIAL.d' +
        'bo.SZ7010 (nolock) '
      '                               Where Z7_FILIAL  = '#39'010101'#39
      '                               AND Z7_CUSERID = '#39'000020'#39
      '                               AND D_E_L_E_T_  <> '#39'*'#39
      '                            )'
      
        '      AND (Rtrim(Armazem.Z1_COD) + '#39' - '#39' + Rtrim(Armazem.Z1_DESC' +
        ')) = '#39'PE - PERSONALIZACAO'#39
      ') TB '
      ' Where 1=1 '
      ' '
      'Order by Empresa, Armazem_FK, Produto_FK, DiasEmEstoque desc ')
    Left = 251
    Top = 60
    ...
    object QuerySaldoB2: TFloatField
      FieldName = 'SaldoB2'
    end
    object QuerySaldoB8: TFloatField
      FieldName = 'SaldoB8'
    end
    object QuerySaldoTotalB8: TFloatField
      FieldName = 'SaldoTotalB8'
      ReadOnly = True
    end
    ...
    object QueryPeriodoProdutivo: TStringField
      FieldName = 'PeriodoProdutivo'
      ReadOnly = True
      Size = 43
    end
    object QueryDataEstoque: TDateTimeField
      FieldName = 'DataEstoque'
      ReadOnly = True
    end
    ...
    object QueryStatusValidade: TStringField
      FieldName = 'StatusValidade'
      ReadOnly = True
      Size = 8
    end
    object QueryDiasEmEstoque: TIntegerField
      FieldName = 'DiasEmEstoque'
      ReadOnly = True
    end
    object QueryDiferenca: TFloatField
      FieldName = 'Diferenca'
      ReadOnly = True
    end
    object QueryDesbalanceado: TStringField
      FieldName = 'Desbalanceado'
      ReadOnly = True
      Size = 13
    end
    object QuerySaldoNegativo: TStringField
      FieldName = 'SaldoNegativo'
      ReadOnly = True
      Size = 3
    end
  ...
  object ppRelatorio: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel9: TppLabel
        ...
        Border.mmPadding = 0
        Caption = 'Saldo de Estoque por Lote'
