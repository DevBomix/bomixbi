...
begin
    ...
    VLC_Select := VLC_Select + '		Select  ' + #13;
    VLC_Select := VLC_Select + '		' + '''' + 'DEVOLUÇÃO' + '''' + ' as Tipo, Rtrim(F1_FILIAL) as Empresa, Convert(Datetime,F1_EMISSAO,112) as Emissao, ' + #13;
...
begin
    ...
    VLC_Select := VLC_Select + '		Select ' + #13;
    VLC_Select := VLC_Select + '		' + '''' + 'SAÍDA' + '''' + ' as Tipo, Rtrim(F2_FILIAL) as Empresa, Convert(Datetime,F2_EMISSAO,112) as Emissao, ' + #13;
