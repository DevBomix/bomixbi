inherited RelatorioEstoqueSoproControleLoop: TRelatorioEstoqueSoproControleLoop
  Caption = 'Controle de Entrada e Saida - Loop'
  ClientHeight = 325
  ClientWidth = 685
  OnShow = FormShow
  ExplicitWidth = 691
  ...
  object Panel26: TPanel [4]
    ...
    object DT_DataEmissao1: TDateTimePicker
      ...
      Width = 159
      Height = 24
      Date = 41335.424179409730000000
      Time = 41335.424179409730000000
  ...
  object Panel15: TPanel [7]
    ...
    object CBX_OperadorLote: TComboBox
      ...
      TabStop = False
      Text = 'Cont'#233'm'
      OnChange = CBX_OperadorLoteChange
      Items.Strings = (
        'Iniciado por'
        'Igual'
        'Terminado por'
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      'Select '
        ...
        #9#39'SA'#205'DA'#39' as Tipo, Rtrim(F2_FILIAL) as Empresa, Convert(Datetime,' +
        'F2_EMISSAO,112) as Emissao, '
      
        #9'Rtrim(F2_DOC) as Nota, F2_SERIE as Serie, D2_ITEM as Sequencia,' +
        ' '
      
        #9'Rtrim(F2_CLIENTE) as Cliente_ID, F2_LOJA as Loja, Rtrim(A1_NOME' +
        ') as RazaoSocial, '
      
        #9'D2_TES as Tes, Ltrim(Rtrim(F4_TEXTO)) as Texto, D2_LOCAL as Arm' +
        'azem_ID, Rtrim(D2_LOCAL) + '#39' - '#39' + Rtrim(Z1_DESC) as Armazem,'
      
        #9'Rtrim(D2_COD) as Produto_ID, Rtrim(B1_DESC) as Produto, D2.D2_L' +
        'OTECTL as Lote, '
      #9'D2_QUANT as Quantidade, Rtrim(D2_UM) as UnidadeMedida'
      'from P12OFICIAL.dbo.SF2010 F2 (nolock)'
      
        'Inner Join P12OFICIAL.dbo.SD2010 D2 (nolock) ON D2.D_E_L_E_T_ <>' +
        ' '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND D2.D2_FILIAL = '#39'020101'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND F2_DOC = D2_DOC'
      
        'Inner Join P12OFICIAL.dbo.SA1010 A1 (nolock) ON A1.A1_FILIAL = '#39 +
        '0201'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND A1.D_E_L_E_T_ <> '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND A1.A1_COD = F2_CLIENTE'
      #9#9#9#9#9#9#9#9#9#9#9'AND A1.A1_LOJA = F2_LOJA'
      
        'Inner Join P12OFICIAL.dbo.SF4010 F4 (nolock) ON F4.D_E_L_E_T_ <>' +
        ' '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND F4_FILIAL = '#39'0201'#39' '
      #9#9#9#9#9#9#9#9#9#9#9'AND F4_CODIGO = D2_TES'
      
        'Inner Join P12OFICIAL.dbo.SB1010 B1 (nolock) ON B1.D_E_L_E_T_ <>' +
        ' '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND B1_FILIAL = '#39'0201'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND B1_COD = D2_COD'
      
        'Inner Join P12OFICIAL.dbo.SZ1010 Z1 (nolock) ON Z1.D_E_L_E_T_ <>' +
        ' '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Z1.Z1_FILIAL = '#39'020101'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Z1_COD = D2_LOCAL'#9#9#9#9#9#9#9#9#9#9#9
      'Where F2_FILIAL = '#39'020101'#39
      'AND Rtrim(F2_CLIENTE) = '#39'000601'#39' AND F2_LOJA = '#39'01'#39
      
        'AND Convert(Datetime,F2_EMISSAO,112) between '#39'2018-01-01 00:00:0' +
        '0.000'#39' AND '#39'2018-03-23 00:00:00.000'#39
      ''
      'Union all'
      ''
      'Select '
      
        #9#39'DEVOLU'#199#195'O'#39' as Tipo, Rtrim(F1_FILIAL) as Empresa, Convert(Datet' +
        'ime,F1_EMISSAO,112) as Emissao, '
      
        #9'Rtrim(F1_DOC) as Nota, F1_SERIE as Serie, D1.D1_ITEM as Sequenc' +
        'ia, '
      
        #9'Rtrim(F1_FORNECE) as Fornecedor_ID, F1_LOJA as Loja, Rtrim(A2_N' +
        'OME) as RazaoSocial, '
      
        #9'D1_TES as Tes, Ltrim(Rtrim(F4_TEXTO)) as Texto, D1_LOCAL as Arm' +
        'azem_ID, Rtrim(D1_LOCAL) + '#39' - '#39' + Rtrim(Z1_DESC) as Armazem,'
      
        #9'Rtrim(D1_COD) as Produto_ID, Rtrim(B1_DESC) as Produto, D1_LOTE' +
        'CTL as Lote, '
      #9'D1_QUANT as Quantidade, Rtrim(D1_UM) as UnidadeMedida'#9' '
      'from P12OFICIAL.dbo.SF1010 F1 (nolock)'
      
        'Inner Join P12OFICIAL.dbo.SD1010 D1 (nolock) ON D1.D_E_L_E_T_ <>' +
        ' '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND D1.D1_FILIAL = '#39'020101'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND F1_DOC = D1_DOC'
      
        'Inner Join P12OFICIAL.dbo.SA2010 A1 (nolock) ON A1.A2_FILIAL = '#39 +
        '0201'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND A1.D_E_L_E_T_ <> '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND A1.A2_COD = F1_FORNECE'
      #9#9#9#9#9#9#9#9#9#9#9'AND A1.A2_LOJA = F1_LOJA'
      
        'Inner Join P12OFICIAL.dbo.SF4010 F4 (nolock) ON F4.D_E_L_E_T_ <>' +
        ' '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND F4_FILIAL = '#39'0201'#39' '
      #9#9#9#9#9#9#9#9#9#9#9'AND F4_CODIGO = D1_TES'
      
        'Inner Join P12OFICIAL.dbo.SB1010 B1 (nolock) ON B1.D_E_L_E_T_ <>' +
        ' '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND B1_FILIAL = '#39'0201'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND B1_COD = D1_COD'
      
        'Inner Join P12OFICIAL.dbo.SZ1010 Z1 (nolock) ON Z1.D_E_L_E_T_ <>' +
        ' '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Z1.Z1_FILIAL = '#39'020101'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Z1_COD = D1_LOCAL'
      ''
      'where F1_FILIAL = '#39'020101'#39
      'AND F1.D_E_L_E_T_ <> '#39'*'#39' '
      'AND F1_FORNECE = '#39'000640'#39' AND A2_LOJA = '#39'1'#39
      
        'AND Convert(Datetime,F1_EMISSAO,112) between '#39'2018-01-01 00:00:0' +
        '0.000'#39' AND '#39'2018-03-23 00:00:00.000'#39
      ''
      'Order by Emissao desc, Produto_ID')
    Left = 499
    Top = 12
    ...
    object QueryTexto: TStringField
      FieldName = 'Texto'
      ReadOnly = True
      Size = 60
    end
    ...
    object QueryUnidadeMedida: TStringField
      FieldName = 'UnidadeMedida'
      ReadOnly = True
      Size = 6
    end
