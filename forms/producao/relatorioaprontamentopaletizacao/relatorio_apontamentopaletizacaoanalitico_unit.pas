...
begin
  ...
  begin
     LBL_Periodo.Caption :=  ' Data de Emissão Entre ' + ' ' + DateToStr(Relatorio_ApontamentoPaletizacao.DT_DataEmissao1.Date) + ' a ' + DateToStr(Relatorio_ApontamentoPaletizacao.DT_DataEmissao2.Date);
