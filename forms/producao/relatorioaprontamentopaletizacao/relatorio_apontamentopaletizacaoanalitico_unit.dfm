object Relatorio_ApontamentoPaletizacaoAnalitico: TRelatorio_ApontamentoPaletizacaoAnalitico
  Left = 0
  Top = 0
  Caption = 'Relatorio_ApontamentoPaletizacaoAnalitico'
  ClientHeight = 299
  ClientWidth = 635
  Color = clBtnFace
  ...
  object ppApontamento: TppReport
    ...
    object ppHeaderBand5: TppHeaderBand
      ...
      object ppLabel33: TppLabel
        ...
        Caption = 'Apontamento de Paletiza'#231#227'o'
  ...
  object Query_Apontamento: TADOQuery
    ...
    SQL.Strings = (
      ...
      ' Select    '
        ...
        'ontamento.DataTurno, Apontamento.Turno, Apontamento.TurnoDescric' +
        'ao,'
      
        #9'DataIni, HoraIni, DataFin, HoraFin, Recurso_ID, Apontamento.Rec' +
        'urso, '
      
        '   '#9'Apontamento.OrdemProducao, Grupo, Produto_ID, Apontamento.Pr' +
        'oduto, Cor, Apontamento.Item, Peso, Tipo, Lote, Armazem, QtdProd' +
        'uzida as ProduzidoA, '
      '  '#9'Apontamento.Recno as Apontamento_Recno  '
      
        ' from BomixBI.[dbo].[Pcp_TB_OrdemPaletizacaoApontamentoRelatorio' +
        '] Apontamento (nolock) '
      ' Where Apontamento.Empresa = '#39'0101'#39
      
        ' AND Apontamento.DataTurno Between  CONVERT(Datetime,Convert(Var' +
        'char(10),'#39'28/02/2018 10:10:49'#39',103),103)'
      
        ' AND CONVERT(Datetime,Convert(Varchar(10),'#39'28/02/2018 10:10:49'#39',' +
        '103),103)'
      ' AND rtrim(Apontamento.Area) in ('#39'PALETIZACAO'#39')'
      ' '
      
        ' Order by Apontamento.DataTurno desc, Apontamento.Setor, Recurso' +
        '_ID desc, Apontamento.Turno, DataIni, HoraIni')
    Left = 79
    Top = 17
