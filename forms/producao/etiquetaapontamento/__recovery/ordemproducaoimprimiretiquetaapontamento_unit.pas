...
begin
     ...
     begin
         Application.MessageBox('Estorne este Apontamento no Totvs Protheus separando as quantidades de Peças Boas e Perdas em dois apontamentos destintos.' + #13 + '','Atenção',mb_iconerror + mb_ok);
...
begin
    ...
    CorrigirDadosApontamento('Já Impressa');
...
begin
  ...
  begin
       Application.MessageBox('Não é possivel listar todas as Ordens de Produção! Favor coloque o Código da OP ou do Produto' + #13 + '','Atenção',mb_iconerror + mb_ok);
       TXT_Buscador.SetFocus;
       Exit;
  end;
