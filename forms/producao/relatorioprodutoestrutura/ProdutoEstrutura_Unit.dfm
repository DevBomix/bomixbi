inherited Relatorio_EstruturaProduto: TRelatorio_EstruturaProduto
  Caption = 'Estrutura de Produto'
  ClientHeight = 230
  ClientWidth = 686
  OnCreate = FormCreate
  ExplicitWidth = 692
  ...
  object Panel1: TPanel [4]
    ...
    object CBX_Operador_Produto: TComboBox
      Left = 197
      Top = 4
      Width = 134
      Height = 23
      ...
      TabStop = False
      Text = 'Cont'#233'm'
      OnChange = CBX_Operador_ProdutoChange
      Items.Strings = (
        'Iniciado por'
        'Igual'
        'Terminado por'
    ...
    object Panel2: TPanel
      ...
      ParentFont = False
      TabOrder = 3
      object PNL_Sinal_Produto: TPanel
        Left = 174
        Top = 1
        Width = 13
        Height = 21
        ...
        ParentBackground = False
        TabOrder = 0
        OnClick = PNL_Sinal_ProdutoClick
      end
    end
  ...
  object Panel4: TPanel [5]
    ...
    ParentBackground = False
    TabOrder = 5
    object TXT_Valor2_InsumoID: TMaskEdit
      Left = 494
      Top = 4
      Width = 160
      Height = 23
    ...
    object CBX_Operador_InsumoID: TComboBox
      Left = 197
      Top = 4
      Width = 134
      Height = 23
      ...
      TabStop = False
      Text = 'Cont'#233'm'
      OnChange = CBX_Operador_InsumoIDChange
      Items.Strings = (
        'Iniciado por'
        'Igual'
        'Terminado por'
    ...
    object TXT_Valor1_InsumoID: TMaskEdit
      Left = 334
      Top = 4
      Width = 159
      Height = 23
    ...
    object Panel5: TPanel
      ...
      ParentFont = False
      TabOrder = 3
      object PNL_Sinal_InsumoID: TPanel
        Left = 174
        Top = 1
        Width = 13
        Height = 21
        ...
        ParentBackground = False
        TabOrder = 0
        OnClick = PNL_Sinal_InsumoIDClick
      end
    end
  ...
  object Panel7: TPanel [6]
    ...
    ParentBackground = False
    TabOrder = 6
    object TXT_Valor2_Insumo: TMaskEdit
      Left = 495
      Top = 4
      Width = 160
      Height = 23
    ...
    object CBX_Operador_Insumo: TComboBox
      Left = 197
      Top = 4
      Width = 134
      Height = 23
      ...
      TabStop = False
      Text = 'Cont'#233'm'
      OnChange = CBX_Operador_InsumoChange
      Items.Strings = (
        'Iniciado por'
        'Igual'
        'Terminado por'
    ...
    object TXT_Valor1_Insumo: TMaskEdit
      Left = 334
      Top = 4
      Width = 159
      Height = 23
    ...
    object Panel8: TPanel
      ...
      ParentFont = False
      TabOrder = 3
      object PNL_Sinal_Insumo: TPanel
        Left = 174
        Top = 1
        Width = 13
        Height = 21
  ...
  object CDS: TClientDataSet
    ...
    Left = 688
    Top = 96
    object CDSG1Recno: TIntegerField
      FieldName = 'G1Recno'
    end
    ...
    object CDSQtdBase: TFloatField
      FieldName = 'QtdBase'
    end
    object CDSGrupo_ID: TStringField
      FieldName = 'Grupo_ID'
      Size = 4
    end
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      'Select Top 20 '
      #9'G1.R_E_C_N_O_ as G1Recno, G1.G1_FILIAL as Empresa,  '
      #9'Produto.B1_BRTPPR as TipoProduto,  '
      
        #9'Rtrim(G1.G1_COD) as Produto_ID, Rtrim(Produto.B1_DESC) as Produ' +
        'to,  '
      #9'Produto.B1_QB as QtdBase,  '
      #9'Grupo.BM_GRUPO as Grupo_ID, Grupo.BM_DESC as Grupo, '
      #9'Insumo.B1_BRTPPR as TipoInsumo, '
      #9'G1.G1_COMP as Insumo_ID, Insumo.B1_DESC as Insumo, '
      #9'G1.G1_QUANT as Quantidade, Insumo.B1_UM as UM '
      ' '
      'from P12OFICIAL.dbo.SG1010 G1 '
      
        'Inner Join P12OFICIAL.dbo.SB1010 as Produto ON Produto.B1_FILIAL' +
        ' = '#39'0101'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Produto.D_E_L_E_T_ <> '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Produto.B1_COD = G1.G1_COD '
      ' '
      
        'Inner Join P12OFICIAL.dbo.SB1010 as Insumo ON Insumo.B1_FILIAL =' +
        ' '#39'0101'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Insumo.D_E_L_E_T_ <> '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Insumo.B1_COD = G1.G1_COMP '
      
        'Inner Join P12OFICIAL.dbo.SBM010 as Grupo ON Grupo.BM_FILIAL = '#39 +
        '0101'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Grupo.D_E_L_E_T_ <> '#39'*'#39
      #9#9#9#9#9#9#9#9#9#9#9'AND Grupo.BM_GRUPO = Produto.B1_GRUPO '
      ' '
      'Where 1=1 '
      'AND G1.G1_COD like '#39'%B18H%'#39
      'AND G1_FILIAL = '#39'010101'#39
      'AND G1.D_E_L_E_T_ <> '#39'*'#39
      'Order by G1_FILIAL, G1.G1_COD, G1.G1_COMP ')
    Left = 724
    Top = 96
    object QueryG1Recno: TIntegerField
      FieldName = 'G1Recno'
    end
    ...
    object QueryQtdBase: TFloatField
      FieldName = 'QtdBase'
    end
    object QueryGrupo_ID: TStringField
      FieldName = 'Grupo_ID'
      Size = 4
    end
  ...
  object ppReport: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLBL_TituloRelatorio: TppLabel
        ...
        Border.mmPadding = 0
        Caption = 'Relat'#243'rio de Estrutura de Produto'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 20
