...
begin
  ...
  begin
      Application.MessageBox('Nenhum Registro para Impressão' + #13 + 'Consulte o Administrador do sistema','Atenção',mb_iconwarning + mb_ok);
      Exit;
  end;
  begin
      ppLBL_Usuario.Caption := Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption + ' // Data Impressão: ' + DateTimeToStr(Date());
