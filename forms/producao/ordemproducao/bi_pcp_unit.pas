...
begin
  ...
  if CBX_TipoData.Text = 'ÚLTIMO APONTAMENTO' then
  begin
...
begin
     ...
     // Filtro de Status da Ordem de Produção ***************************************
...
begin
        ...
        begin
            VLC_Select := VLC_Select + '  AND  OrdemProducao.RodouCargaMaquina = ' + '''' + 'Não' + '''' + #13;
        end;
        ...
        begin
            VLC_Select := VLC_Select + '  AND  OrdemProducao.ZerarRotulo = ' + '''' + 'Não' + '''' + #13;
        end;
        ...
        begin
            VLC_Select := VLC_Select + '  AND  OrdemProducao.GerarOP = ' + '''' + 'Não' + '''' + #13;
        end;
