inherited Relatorio_PeriodicoFaturamentoxProducao: TRelatorio_PeriodicoFaturamentoxProducao
  Caption = 'Peri'#243'dico de Faturamento x Produ'#231#227'o'
  ClientHeight = 189
  ClientWidth = 690
  OnShow = FormShow
  ExplicitWidth = 696
  ...
  object Panel4: TPanel [3]
    ...
    object CBX_TipoRelatorio: TComboBox
      ...
      ParentFont = False
      TabOrder = 1
      Text = 'Peri'#243'dico de Faturamento x Produ'#231#227'o - DI'#193'RIO'
      Items.Strings = (
        'RELAT'#211'RIO DE FATURAMENTO - DI'#193'RIO'
        'RELAT'#211'RIO DE FATURAMENTO - MENSAL'
        'RELAT'#211'RIO DE FATURAMENTO - BIMESTRAL')
    end
  end
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
        ...
        'Select * from BomixBI.[dbo].Fat_TB_PeriodicoFaturamento_X_Produc' +
        'ao (nolock) '
      'Where 1=1 '#9#11
      
        'AND DataTurno Between '#39'2020-08-25 00:00:00'#39' AND '#39'2020-09-29 23:5' +
        '9:00'#39
      ' Order by Tempo_ID desc ')
    Left = 238
    Top = 144
    object QueryTempo_ID: TIntegerField
      FieldName = 'Tempo_ID'
    end
    ...
    object QueryTonelagemProduzida: TFloatField
      FieldName = 'TonelagemProduzida'
    end
    object QueryTonelagemVendida: TFloatField
      FieldName = 'TonelagemVendida'
    end
    object QueryDiferenca: TFloatField
      FieldName = 'Diferenca'
    end
    object QueryProdutiva: TIntegerField
      FieldName = 'Produtiva'
    end
    object QueryParada: TIntegerField
      FieldName = 'Parada'
    end
    object QueryTotalRecurso: TIntegerField
      FieldName = 'TotalRecurso'
    end
  end
  object CDS: TClientDataSet
    ...
    Left = 208
    Top = 144
    object CDSTempo_ID: TIntegerField
      FieldName = 'Tempo_ID'
    end
    ...
    object CDSTonelagemProduzida: TFloatField
      FieldName = 'TonelagemProduzida'
    end
    object CDSTonelagemVendida: TFloatField
      FieldName = 'TonelagemVendida'
    end
    object CDSDiferenca: TFloatField
      FieldName = 'Diferenca'
    end
    object CDSProdutiva: TIntegerField
      FieldName = 'Produtiva'
    end
    object CDSParada: TIntegerField
      FieldName = 'Parada'
    end
    object CDSTotalRecurso: TIntegerField
      FieldName = 'TotalRecurso'
    end
  end
  object ppReport: TppReport
    ...
    object ppHeaderBand16: TppHeaderBand
      ...
      object ppLabel278: TppLabel
        ...
        Border.mmPadding = 0
        Caption = 'Peri'#243'dico de Faturamento x Produ'#231#227'o - DI'#193'RIO'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 16
