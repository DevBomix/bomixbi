object RelatorioUltimoFaturamentoProduto_Query: TRelatorioUltimoFaturamentoProduto_Query
  Left = 0
  Top = 0
  Caption = 'RelatorioUltimoFaturamentoProduto_Query'
  ClientHeight = 182
  ClientWidth = 405
  Color = clBtnFace
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      'Select'
        ...
        ' '#9'Grupo, Item, Item.Produto_ID, Produto, Nota, Nota.Cliente, Not' +
        'a.UF as UF, '
      
        ' '#9'Nota.Vendedor_FK as Vendedor_FK,  Nota.Vendedor, Nota.Gerente,' +
        ' Item.ValorUnitario as Preco,'
      
        ' '#9'D2_Emissao as UltimaVendaEmissao, DATEDIFF(Day,D2_Emissao,GetD' +
        'ate()) as QtdDias,'
      ' '#9'D2_Recno as Recno, Item.D2_Empresa as Empresa '
      ...
      'Inner Join ('
      #9#9#9#9'Select D2_Empresa, Produto_ID, Max(D2_Recno) D2_RecnoMax'
      #9#9#9#9'from BomixBI.dbo.Fat_TB_NotaFiscalVenda Nota (nolock) '
      
        #9#9#9#9'Inner Join BomixBI.dbo.Fat_TB_NotaFiscalVendaItem Item (nolo' +
        'ck) On Nota.F2_Recno = Item.F2_RecnoFK'
      #9#9#9#9'Where ComissaoVendedor in ('#39'Soma'#39')'
      #9#9#9#9'AND TipoProduto <> '#39'N'#195'O DEFINIDO'#39
      #9#9#9#9'Group by D2_Empresa, Produto_ID'
      ''
      #9#9#9') ULtimaVenda ON ULtimaVenda.D2_RecnoMax = D2_Recno '
    ...
    object QueryUltimaVendaEmissao: TDateTimeField
      FieldName = 'UltimaVendaEmissao'
    end
    object QueryQtdDias: TIntegerField
      FieldName = 'QtdDias'
      ReadOnly = True
    end
  ...
  object CDS: TClientDataSet
    ...
    object CDSUltimaVendaEmissao: TDateTimeField
      FieldName = 'UltimaVendaEmissao'
    end
    object CDSQtdDias: TIntegerField
      FieldName = 'QtdDias'
      ReadOnly = True
    end
