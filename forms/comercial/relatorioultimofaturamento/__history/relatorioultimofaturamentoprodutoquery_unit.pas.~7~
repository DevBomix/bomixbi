...
begin
  ...
  If RelatorioUltimoFaturamentoProduto.CBX_OrdenarPor.Text = 'TEMPO DA ÚLTIMA COMPRA - CRESCENTE' then VLC_OrderBy := ' Order by D2_Emissao ' + #13;
  If RelatorioUltimoFaturamentoProduto.CBX_OrdenarPor.Text = 'TEMPO DA ÚLTIMA COMPRA - DESCRESCENTE' then VLC_OrderBy := ' Order by D2_Emissao Desc ' + #13;
  ...
  If RelatorioUltimoFaturamentoProduto.CBX_OrdenarPor.Text = 'GERÊNCIA' then   VLC_OrderBy := ' Order by Nota.Gerente ' + #13;
