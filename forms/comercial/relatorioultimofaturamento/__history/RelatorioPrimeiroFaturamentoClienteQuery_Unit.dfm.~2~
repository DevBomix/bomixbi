object RelatorioPrimeiroFaturamentoCliente_Query: TRelatorioPrimeiroFaturamentoCliente_Query
  Left = 0
  Top = 0
  Caption = 'RelatorioPrimeiroFaturamentoCliente_Query'
  ClientHeight = 299
  ClientWidth = 635
  Color = clBtnFace
  ...
  object ppRelatorio: TppReport
    ...
    object ppHeaderBand5: TppHeaderBand
      ...
      object ppLabel33: TppLabel
        ...
        Border.mmPadding = 0
        Caption = 'Primeiro Faturamento (Cliente)'
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ...
      ' Select '
        ...
        ' '#9'Nota.F2_Empresa as Empresa, Nota.Cliente_ID, Nota.Loja, Nota.C' +
        'liente, Nota.Cidade, Nota.UF, Nota.Vendedor_FK, Nota.Vendedor,'
      
        ' '#9'Nota.Gerente, Nota, Emissao, DATEDIFF(Day,Emissao,GetDate()) a' +
        's QtdDias'
      ' from BomixBI.[dbo].[Fat_TB_NotaFiscalVenda] Nota (nolock)'
      ' Inner Join ('
      '  '
      
        ' '#9#9#9#9'Select F2_Empresa, Cliente_ID, Loja, Max(F2_Recno) F2_Recno' +
        'Max '
      ...
      ' '#9#9#9#9'Group by F2_Empresa, Cliente_ID, Loja'
      '  '
      ' '#9#9#9') ULtimaVenda ON ULtimaVenda.F2_RecnoMax = F2_Recno '
      ' Where Nota.F2_Empresa = '#39'0101'#39
      '   Order by Emissao ')
    Left = 71
    Top = 95
