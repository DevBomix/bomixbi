unit RelatorioPrimeiroFaturamentoClienteQuery_Unit;
...
type
  TRelatorioPrimeiroFaturamentoCliente_Query = class(TForm)
...
var
  RelatorioPrimeiroFaturamentoCliente_Query: TRelatorioPrimeiroFaturamentoCliente_Query;
...
{ TRelatorioPrimeiroFaturamentoCliente_Query }

function TRelatorioPrimeiroFaturamentoCliente_Query.ImprimirRelatorio: Boolean;
Var
...
begin
  ...
  VLC_Select := VLC_Select + ' 				Select F2_Empresa, Cliente_ID, Loja, Min(F2_Recno) F2_RecnoMax ' + #13;
  VLC_Select := VLC_Select + ' 				from BomixBI.dbo.Fat_TB_NotaFiscalVenda Nota (nolock) ' + #13;
