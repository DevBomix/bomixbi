inherited RelatorioUltimoFaturamentoCliente: TRelatorioUltimoFaturamentoCliente
  Caption = #218'ltimo Faturamento (Cliente)'
  ClientHeight = 345
  ClientWidth = 684
  OnCreate = FormCreate
  ExplicitWidth = 690
  ...
  object Panel4: TPanel [4]
    ...
    object CBX_TipoRelatorio: TComboBox
      ...
      ParentFont = False
      TabOrder = 1
      Text = #218'LTIMO FATURAMENTO (CLIENTE)'
      OnChange = CBX_TipoRelatorioChange
      Items.Strings = (
        #218'LTIMO FATURAMENTO (CLIENTE)'
        'PRIMEIRO FATURAMENTO (CLIENTE)')
    end
  end
  ...
  object Panel23: TPanel [7]
    ...
    object CBX_OrdenarPor: TComboBox
      ...
      TabOrder = 4
      TabStop = False
      Text = 'TEMPO DA '#218'LTIMA COMPRA - CRESCENTE'
      Items.Strings = (
        'TEMPO DA '#218'LTIMA COMPRA - CRESCENTE'
        'TEMPO DA '#218'LTIMA COMPRA - DESCRESCENTE'
        'CLIENTE'
        'GER'#202'NCIA'
        'VENDEDOR')
    end
