inherited BI_RelacionamentoCliente_FiltroSegmento: TBI_RelacionamentoCliente_FiltroSegmento
  Caption = 'Segmento'
  OnCreate = FormCreate
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited Query: TADOQuery
    SQL.Strings = (
      ''
      ' Select Distinct Segmento_FK, Segmento, SetorMercado from (  '
      '  Select '
      '    *   '
      ...
      ''
      ' ) TB '
      '  Where (Segmento + SetorMercado) Like '#39'%%'#39'  '
