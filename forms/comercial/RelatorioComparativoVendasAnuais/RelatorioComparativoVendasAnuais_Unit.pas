...
begin
    ...
    begin
       ...
       ppLBL_Comparacao.Caption :=  'Comparação: ' + ' ' + DateToStr(DT_Comparacao1.Date) + ' a ' + DateToStr(DT_Comparacao2.Date);
...
begin
    ...
    begin
         ...
         ppLabel7.Caption :=  'Comparação: ' + ' ' + DateToStr(DT_Comparacao1.Date) + ' a ' + DateToStr(DT_Comparacao2.Date);
...
begin
    ...
    begin
       ...
       ppLabel19.Caption :=  'Comparação: ' + ' ' + DateToStr(DT_Comparacao1.Date) + ' a ' + DateToStr(DT_Comparacao2.Date);
