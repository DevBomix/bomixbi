object RelatorioParametrizadoVendas_VendedorXVendedor: TRelatorioParametrizadoVendas_VendedorXVendedor
  Left = 0
  Top = 0
  Caption = 'RelatorioParametrizadoVendas_VendedorXVendedor'
  ClientHeight = 299
  ClientWidth = 635
  Color = clBtnFace
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ...
      ' '
        ...
        '   '#39'Soma / Subtrai'#39' as ComissaoVendedor, Vendedor, SUM(Quantidad' +
        'e) as Quantidade, Sum(ValorUnitario) as ValorUnitario,'
      ...
      ' '
      #9') TB'
      '    Group By ComissaoVendedor, Vendedor'
      ''
      ') TB Group by Vendedor'
      'Order By Vendedor')
    Left = 136
    Top = 50
  ...
  object ppRelatorio: TppReport
    ...
    object ppHeaderBand16: TppHeaderBand
      ...
      object ppLabel278: TppLabel
        ...
        Caption = 'Relat'#243'rio Parametrizado de Vendas (Vendedor x Vendedor) '
