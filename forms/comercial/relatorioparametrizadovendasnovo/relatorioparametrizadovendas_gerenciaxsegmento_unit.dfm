object RelatorioParametrizadoVendas_GerenciaXSegmento: TRelatorioParametrizadoVendas_GerenciaXSegmento
  Left = 0
  Top = 0
  Caption = 'RelatorioParametrizadoVendas_GerenciaXSegmento'
  ClientHeight = 299
  ClientWidth = 635
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object ppDBGerenciaXSegmento: TppDBPipeline
    DataSource = DS_GerenciaXSegmento
    CloseDataSource = True
    UserName = 'DBGerenciaXSegmento'
    Left = 76
    Top = 134
    object ppDBGerenciaXSegmentoppField1: TppField
    ...
    object ppDBGerenciaXSegmentoppField2: TppField
      FieldAlias = 'Gerente'
      FieldName = 'Gerente'
      FieldLength = 100
      DisplayWidth = 100
    ...
    object ppDBGerenciaXSegmentoppField3: TppField
    ...
    object ppDBGerenciaXSegmentoppField4: TppField
      FieldAlias = 'Segmento'
      FieldName = 'Segmento'
      FieldLength = 80
      DisplayWidth = 80
    ...
    object ppDBGerenciaXSegmentoppField5: TppField
    ...
    object ppDBGerenciaXSegmentoppField6: TppField
      Alignment = taRightJustify
    ...
    object ppDBGerenciaXSegmentoppField7: TppField
      Alignment = taRightJustify
      FieldAlias = 'MediaKG'
      FieldName = 'MediaKG'
      FieldLength = 0
    ...
    object ppDBGerenciaXSegmentoppField8: TppField
      Alignment = taRightJustify
      FieldAlias = 'Peso'
      FieldName = 'Peso'
      FieldLength = 0
    ...
    object ppDBGerenciaXSegmentoppField9: TppField
      Alignment = taRightJustify
    ...
    object ppDBGerenciaXSegmentoppField10: TppField
      Alignment = taRightJustify
      FieldAlias = 'ValorPCC'
      FieldName = 'ValorPCC'
      FieldLength = 0
    ...
    object ppDBGerenciaXSegmentoppField11: TppField
      Alignment = taRightJustify
  ...
  object Query_GerenciaXSegmento: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT '#39'Soma / Subtrai'#39' as ComissaoVendedor, Gerente, SetorMerca' +
        'do, Segmento, SUM(Quantidade) as Quantidade, '
      
        ' Sum(ValorUnitario) as ValorUnitario, Case When SUM(Peso) > 0 Th' +
        'en (Sum(ValorPCC)/ SUM(Peso)) else 0  end as MediaKG, Sum(Peso) ' +
        'as Peso, '
      
        ' Sum(ValorLiquido) as ValorLiquido, Sum(ValorPCC) as ValorPCC, S' +
        'um(ValorBruto) as ValorBruto  FROM ( '
      '  '
      ' '#9#9'SELECT ComissaoVendedor, Gerente, SetorMercado, Segmento,'
      ...
      '  FROM ('
        ...
        #9#9'Where Nota.Emissao Between '#39'2020-07-26 00:00:00'#39' AND '#39'2020-08-' +
        '25 23:59:00'#39
      ...
      '    Union All'
        ...
        #9#9'Where Devolucao.Emissao Between '#39'2020-07-26 00:00:00'#39' AND '#39'202' +
        '0-08-25 23:59:00'#39
      ' AND F2_Empresa = '#39'0101'#39
      #9#9'AND Item.Faturamento <> '#39'N'#227'o Comercial'#39
      
        ' '#9') TB   Where Emissao between '#39'2020-07-26 00:00:00'#39' AND '#39'2020-0' +
        '8-25 23:59:00'#39
      ' AND ComissaoVendedor in ('#39'Soma'#39','#39'Subtrai'#39','#39'Complementar'#39')'
      '  Group By ComissaoVendedor, Gerente, SetorMercado, Segmento '
      ') TB Group by Gerente, Segmento, SetorMercado '
      ' Order By ComissaoVendedor, Gerente, SetorMercado, Segmento')
    Left = 136
    Top = 134
    object Query_GerenciaXSegmentoComissaoVendedor: TStringField
      FieldName = 'ComissaoVendedor'
      ReadOnly = True
      Size = 14
    end
    object Query_GerenciaXSegmentoGerente: TStringField
      FieldName = 'Gerente'
      ReadOnly = True
      Size = 100
    end
    object Query_GerenciaXSegmentoSetorMercado: TStringField
      FieldName = 'SetorMercado'
      ReadOnly = True
      Size = 55
    end
    object Query_GerenciaXSegmentoSegmento: TStringField
      FieldName = 'Segmento'
      ReadOnly = True
      Size = 80
    end
    object Query_GerenciaXSegmentoQuantidade: TIntegerField
      FieldName = 'Quantidade'
      ReadOnly = True
    end
    object Query_GerenciaXSegmentoValorUnitario: TFloatField
      FieldName = 'ValorUnitario'
      ReadOnly = True
    end
    object Query_GerenciaXSegmentoMediaKG: TFloatField
      FieldName = 'MediaKG'
      ReadOnly = True
    end
    object Query_GerenciaXSegmentoPeso: TFloatField
      FieldName = 'Peso'
      ReadOnly = True
    end
    object Query_GerenciaXSegmentoValorLiquido: TFloatField
      FieldName = 'ValorLiquido'
      ReadOnly = True
    end
    object Query_GerenciaXSegmentoValorPCC: TFloatField
      FieldName = 'ValorPCC'
      ReadOnly = True
    end
    object Query_GerenciaXSegmentoValorBruto: TFloatField
      FieldName = 'ValorBruto'
      ReadOnly = True
    end
  end
  object DS_GerenciaXSegmento: TDataSource
    DataSet = CDS_GerenciaXSegmento
    Left = 166
    Top = 134
  end
  object CDS_GerenciaXSegmento: TClientDataSet
    Active = True
    Aggregates = <>
    Params = <>
    ProviderName = 'DSP_GerenciaXSegmento'
    Left = 196
    Top = 134
    object CDS_GerenciaXSegmentoComissaoVendedor: TStringField
      FieldName = 'ComissaoVendedor'
      ReadOnly = True
      Size = 14
    end
    object CDS_GerenciaXSegmentoGerente: TStringField
      FieldName = 'Gerente'
      ReadOnly = True
      Size = 100
    end
    object CDS_GerenciaXSegmentoSetorMercado: TStringField
      FieldName = 'SetorMercado'
      ReadOnly = True
      Size = 55
    end
    object CDS_GerenciaXSegmentoSegmento: TStringField
      FieldName = 'Segmento'
      ReadOnly = True
      Size = 80
    end
    object CDS_GerenciaXSegmentoQuantidade: TIntegerField
      FieldName = 'Quantidade'
      ReadOnly = True
    end
    object CDS_GerenciaXSegmentoValorUnitario: TFloatField
      FieldName = 'ValorUnitario'
      ReadOnly = True
    end
    object CDS_GerenciaXSegmentoMediaKG: TFloatField
      FieldName = 'MediaKG'
      ReadOnly = True
    end
    object CDS_GerenciaXSegmentoPeso: TFloatField
      FieldName = 'Peso'
      ReadOnly = True
    end
    object CDS_GerenciaXSegmentoValorLiquido: TFloatField
      FieldName = 'ValorLiquido'
      ReadOnly = True
    end
    object CDS_GerenciaXSegmentoValorPCC: TFloatField
      FieldName = 'ValorPCC'
      ReadOnly = True
    end
    object CDS_GerenciaXSegmentoValorBruto: TFloatField
      FieldName = 'ValorBruto'
      ReadOnly = True
    end
  end
  object DSP_GerenciaXSegmento: TDataSetProvider
    DataSet = Query_GerenciaXSegmento
    Left = 226
    Top = 134
  end
  object ppGerenciaXSegmento: TppReport
    AutoStop = False
    DataPipeline = ppDBGerenciaXSegmento
    OnStartPage = ppGerenciaXSegmentoStartPage
    ...
    Version = '19.03'
    mmColumnWidth = 98651
    DataPipelineName = 'ppDBGerenciaXSegmento'
    object ppHeaderBand17: TppHeaderBand
      ...
      object ppLabel310: TppLabel
        ...
        Border.mmPadding = 0
        Caption = 'Relat'#243'rio Parametrizado de Vendas (Ger'#234'ncia x Segmento )'
      ...
      object ppLBL_PeriodoGerenciaXSegmento: TppLabel
        DesignLayer = ppDesignLayer6
        UserName = 'LBL_PeriodoGerenciaXSegmento'
        HyperlinkEnabled = False
        Border.mmPadding = 0
        Caption = 'LBL_PeriodoGerenciaXSegmento'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 9
    ...
    object ppFooterBand17: TppFooterBand
      ...
      object ppMemoGerenciaXSegmento: TppMemo
        DesignLayer = ppDesignLayer6
        UserName = 'MemoGerenciaXSegmento'
        Border.mmPadding = 0
        Caption = 'MemoGerenciaXSegmento'
        CharWrap = False
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
      ...
      object ppLBL_DataGerenciaXSegmento: TppLabel
        DesignLayer = ppDesignLayer6
        UserName = 'LBL_DataGerenciaXSegmento'
        HyperlinkEnabled = False
        Border.mmPadding = 0
        Caption = 'LBL_DataGerenciaXSegmento'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLBL_NumeroPaginaGerenciaXSegmento: TppLabel
        DesignLayer = ppDesignLayer6
        UserName = 'LBL_NumeroPaginaGerenciaXSegmento'
        HyperlinkEnabled = False
        AutoSize = False
        Border.mmPadding = 0
        Caption = 'LBL_NumeroPaginaGerenciaXSegmento'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object LBL_UsuarioGerenciaXSegmento: TppLabel
        DesignLayer = ppDesignLayer6
        UserName = 'LBL_UsuarioGerenciaXSegmento'
        HyperlinkEnabled = False
        Border.mmPadding = 0
        Caption = 'LBL_UsuarioGerenciaXSegmento'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
    ...
    object ppGroup34_GerenciaXCliente: TppGroup
      ...
      object ppGroupFooterBand34: TppGroupFooterBand
        ...
        object ppDBCalc241: TppDBCalc
          ...
          Font.Size = 8
          Font.Style = []
          ResetGroup = ppGroup34_GerenciaXCliente
          TextAlignment = taRightJustified
          Transparent = True
          DataPipelineName = 'ppDBGerenciaXSegmento'
          mmHeight = 3440
    ...
    object ppGroup35_GerenciaXCliente: TppGroup
      BreakName = 'Gerente'
      DataPipeline = ppDBGerenciaXSegmento
      GroupFileSettings.NewFile = False
      GroupFileSettings.EmailFile = False
      ...
      object ppGroupFooterBand35: TppGroupFooterBand
        ...
        object ppDBCalc246: TppDBCalc
          ...
          Font.Size = 8
          Font.Style = []
          ResetGroup = ppGroup35_GerenciaXCliente
          TextAlignment = taRightJustified
          Transparent = True
          DataPipelineName = 'ppDBGerenciaXSegmento'
          mmHeight = 3440
