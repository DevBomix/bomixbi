object RelatorioParametrizadoVendas_ItemXItem: TRelatorioParametrizadoVendas_ItemXItem
  Left = 0
  Top = 0
  Caption = 'RelatorioParametrizadoVendas_ItemXItem'
  ClientHeight = 299
  ClientWidth = 635
  Color = clBtnFace
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ...
      ' '
        ...
        '   '#39'Soma / Subtrai'#39' as ComissaoVendedor, Tamanho, TipoProduto, G' +
        'rupo, Item_ID, Molde, SUM(Quantidade) as Quantidade, Sum(ValorUn' +
        'itario) as ValorUnitario,'
      ...
      '    SELECT'
      ''
      #9#9'ComissaoVendedor, Tamanho, TipoProduto, Grupo, Item_ID, Molde,'
      ...
      #9') TB'
        ...
        '    Group By ComissaoVendedor, Tamanho, TipoProduto, Grupo, Item' +
        '_ID, Molde'
      ''
      ') TB Group by Tamanho, TipoProduto, Grupo, Item_ID, Molde'
      'Order By Tamanho, TipoProduto, Grupo, Item_ID, Molde')
    Left = 136
    Top = 50
  ...
  object ppRelatorio: TppReport
    ...
    XLSSettings.DefaultBands = [btHeader, btColumnHeader, btDetail]
