...
begin
  ...
  // Tipo de Alça
  if (CBX_TipoAlca.Text <> '') then VLC_Filtro := VLC_Filtro + 'Tipo de Alça: ' + CBX_TipoAlca.Text + '; ';
...
begin
    ...
    try
        ...
        begin
          ...
          RelatorioParametrizadoVendas_ClienteXCliente.LBL_Periodo.Caption :=  ' Período entre ' + DateToStr(DT_Valor1_Periodo.Date) + ' a ' + DateToStr(DT_Valor2_Periodo.Date);
...
begin
    ...
    try
        ...
        begin
          //ppMemoGerenciaXGerencia.Lines.Text := 'Filtros: ' + GetFiltros;
          RelatorioParametrizadoVendas_GerenciaXGerencia.LBL_Periodo.Caption :=  ' Período entre ' + DateToStr(DT_Valor1_Periodo.Date) + ' a ' + DateToStr(DT_Valor2_Periodo.Date);
...
begin
    ...
    try
        ...
        begin
          //ppMemoGerenciaXGerencia.Lines.Text := 'Filtros: ' + GetFiltros;
          RelatorioParametrizadoVendas_ItemXItem.LBL_Periodo.Caption :=  ' Período entre ' + DateToStr(DT_Valor1_Periodo.Date) + ' a ' + DateToStr(DT_Valor2_Periodo.Date);
...
begin
    ...
    try
        ...
        begin
          //ppMemoGerenciaXGerencia.Lines.Text := 'Filtros: ' + GetFiltros;
          RelatorioParametrizadoVendas_NotaXNota.LBL_Periodo.Caption :=  ' Período entre ' + DateToStr(DT_Valor1_Periodo.Date) + ' a ' + DateToStr(DT_Valor2_Periodo.Date);
...
begin
    ...
    try
        ...
        begin
          //ppMemoGerenciaXGerencia.Lines.Text := 'Filtros: ' + GetFiltros;
          RelatorioParametrizadoVendas_VendedorXVendedor.LBL_Periodo.Caption :=  ' Período entre ' + DateToStr(DT_Valor1_Periodo.Date) + ' a ' + DateToStr(DT_Valor2_Periodo.Date);
...
begin
  ...
  if CBX_TipoRelatorio.Text = '01.01 - GERÊNCIA X GERÊNCIA' then
...
begin
  ...
  If CBX_Quedra.Text = '01 - GERÊNCIA' then
  begin
      CBX_TipoRelatorio.Items.Clear;
      CBX_TipoRelatorio.Items.Add('01.01 - GERÊNCIA X GERÊNCIA');
      CBX_TipoRelatorio.Text := '01.01 - GERÊNCIA X GERÊNCIA';
      Exit;
  end;
