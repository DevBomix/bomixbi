...
function TRelatorioParametrizadoVendas_ClienteXCliente.GetSelect: String;
Var
  VLC_Select : String;
begin
   ...
   begin
         ...
         VLC_Select := VLC_Select + '   ' + '''' + 'Soma / Subtrai' + '''' + ' as ComissaoVendedor, Cliente_ID, Cliente, UF, Cidade, Segmento, ' + #13;
         VLC_Select := VLC_Select + '   SUM(Quantidade) as Quantidade, Sum(ValorUnitario) as ValorUnitario,' + #13;
         ...
         VLC_Select := VLC_Select + '    SELECT' + #13;
         VLC_Select := VLC_Select + '' + #13;
         VLC_Select := VLC_Select + '		ComissaoVendedor, Cliente_ID, Cliente, UF, Cidade, Segmento,' + #13;
         ...
         VLC_Select := VLC_Select + '    Group By ComissaoVendedor, Cliente_ID, Cliente, UF, Cidade, Segmento' + #13;
         VLC_Select := VLC_Select + '' + #13;
         VLC_Select := VLC_Select + ') TB Group by Cliente_ID, Cliente, UF, Cidade, Segmento' + #13;
         VLC_Select := VLC_Select + 'Order By Cliente_ID, Cliente, UF, Cidade, Segmento' + #13;
   ...
   begin
         ...
         VLC_Select := VLC_Select + ') TB ' + #13;
         VLC_Select := VLC_Select + 'Group by ComissaoVendedor, Cliente_ID, Cliente, UF, Cidade, Segmento ' + #13;
         VLC_Select := VLC_Select + 'Order By ComissaoVendedor, Cliente_ID, Cliente, UF, Cidade, Segmento ' + #13;
...
function TRelatorioParametrizadoVendas_ClienteXCliente.ImprimirRelatorio: Boolean;
Var
   VLC_Select : String;
...
procedure TRelatorioParametrizadoVendas_ClienteXCliente.ppRelatorioStartPage(
  Sender: TObject);
begin
