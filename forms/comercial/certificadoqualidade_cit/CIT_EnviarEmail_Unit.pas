...
begin
    ...
    VLC_Select := VLC_Select + '                                             AND B1.B1_FILIAL =  ' + '''' + Copy(Sys_FuncaoSistema.PNL_EmpresaTotvs.Caption,1,4) + '''' + #13;
...
begin
    ...
    begin
          ...
          IdMessage.Subject := 'Transferência Arquivo Automática - Embarque de Mercadoria';
    ...
    Application.MessageBox('Email Enviado com Sucesso','Atenção',mb_iconwarning + mb_ok);
...
begin
   ...
   TXT_EmailCliente.Text := DS_CITItens.DataSet.FieldByName('EmailCliente').AsString;
    ...
    begin
       ...
       VLC_AlertarEmailCliente := VLC_AlertarEmailCliente + ' CLIENTE NÃO RECEBEU A CIT PORQUE SEU CADASTRO NÃO POSSUE EMAIL ' + #13;
       VLC_AlertarEmailCliente := VLC_AlertarEmailCliente + ' FAVOR VERIFICAR COM URGÊNCIA ' + #13;
       VLC_AlertarEmailCliente := VLC_AlertarEmailCliente + '_____________________________________________________________________' + #13;
    ...
    VLC_EmailCabecario := VLC_EmailCabecario + 'Número Nota Fiscal: ' + DS_CITItens.DataSet.FieldByName('NF').AsString + #13;
    VLC_EmailCabecario := VLC_EmailCabecario + 'Número da CIT: ' + CIT.CDSCit_ID.Value + #13;
