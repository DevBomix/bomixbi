...
begin
  ...
  begin
       Application.MessageBox('Acesso negado para modificar lotes do Certificado de Qualidade.' + #13 + 'Consulte o Administrador do sistema','Atenção',mb_iconwarning + mb_ok);
   end
   else
   begin
