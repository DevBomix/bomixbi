inherited Relatorio_ImprimirEspecificacaoTecnica: TRelatorio_ImprimirEspecificacaoTecnica
  Left = 46
  Caption = '+'
  ClientHeight = 619
  ClientWidth = 882
  ...
  PixelsPerInch = 96
  TextHeight = 13
  inherited PNL_Auxiliar: TPanel [0]
    Width = 867
    Height = 513
    ExplicitWidth = 867
    ExplicitHeight = 513
  ...
  inherited Panel_Titulo: TPanel [1]
    Width = 866
    ExplicitWidth = 866
  ...
  inherited CDS: TClientDataSet
    ...
    object CDSPesoAlca: TIntegerField
      FieldName = 'PesoAlca'
    end
    object CDSPesoTotal: TFloatField
      FieldName = 'PesoTotal'
    end
  ...
  inherited Query: TADOQuery
    SQL.Strings = (
      ...
      'Select * from ('
      #9'Select *,'
      #9#9'(ID + Item + Grupo + Tipo + Tamanho + Formato) as Buscador '
      #9'from BomixBI.dbo.Pcp_TB_ProdutoGrupoItem GrupoItem '
      ') TB'
      'Order by Grupo')
    Left = 364
    Top = 240
    ...
    object QueryFormato: TStringField
      FieldName = 'Formato'
      Size = 30
    end
    object QueryRosca: TStringField
      FieldName = 'Rosca'
      Size = 3
    end
    ...
    object QueryPesoAlca: TIntegerField
      FieldName = 'PesoAlca'
    end
    object QueryPesoTotal: TFloatField
      FieldName = 'PesoTotal'
    end
  ...
  object ppDBPipeline4: TppDBPipeline
    ...
    object ppDBPipeline4ppField1: TppField
      FieldAlias = 'TipoEspecificacao'
      FieldName = 'TipoEspecificacao'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
      Position = 0
  ...
  object CDS_Relatorio: TClientDataSet
    ...
    Left = 325
    Top = 290
    object CDS_RelatorioTipoEspecificacao: TStringField
      FieldName = 'TipoEspecificacao'
      ReadOnly = True
      Size = 7
    end
    object CDS_RelatorioID: TStringField
      FieldName = 'ID'
      Size = 4
    end
    object CDS_RelatorioItem: TStringField
      FieldName = 'Item'
      Size = 50
    end
    object CDS_RelatorioGrupo: TStringField
      FieldName = 'Grupo'
      Size = 50
    end
    object CDS_RelatorioTipo: TStringField
      FieldName = 'Tipo'
      Size = 8
    end
    object CDS_RelatorioTamanho: TStringField
      FieldName = 'Tamanho'
      Size = 8
    end
    object CDS_RelatorioFormato: TStringField
      FieldName = 'Formato'
      Size = 10
    end
    object CDS_RelatorioOrdem: TStringField
      FieldName = 'Ordem'
      Size = 2
    end
    object CDS_RelatorioMedida: TStringField
      FieldName = 'Medida'
      Size = 100
    end
    object CDS_RelatorioUnidade: TStringField
      FieldName = 'Unidade'
      ReadOnly = True
      Size = 2
    end
    object CDS_RelatorioEspecificacao: TStringField
      FieldName = 'Especificacao'
      Size = 10
    end
    object CDS_RelatorioVariacao: TStringField
      FieldName = 'Variacao'
      Size = 10
    end
    object CDS_RelatorioMinino: TStringField
      FieldName = 'Minino'
      Size = 10
    end
    object CDS_RelatorioMaximo: TStringField
      FieldName = 'Maximo'
      Size = 10
    end
  end
  object Query_Relatorio: TADOQuery
    ...
    SQL.Strings = (
      ...
      ' Select '
        ...
        '    '#39' MEDIDA'#39' as TipoEspecificacao, GrupoItem.ID, GrupoItem.Item' +
        ', GrupoItem.Grupo, '
      '  '#9'GrupoItem.Tipo, GrupoItem.Tamanho, GrupoItem.Formato, '
      
        #9'  ZN_ORDEM as Ordem, ZN_MEDIDA as Medida, Lower(ZN.ZN_UNIDADE) ' +
        'as Unidade, ZN_ESPECIF as Especificacao, ZN_VARIA as Variacao, '
      #9'  ZN_MINIMO as Minino, ZN_MAXIMO as Maximo '
      ' from P12Oficial.dbo.SZN010 ZN (nolock)  '
      
        ' Inner Join BomixBI.dbo.Pcp_TB_ProdutoGrupoItem GrupoItem (noloc' +
        'k) ON GrupoItem.ID = ZN.ZN_GRUPO '
      
        '                                   AND GrupoItem.Empresa = Subst' +
        'ring(ZN.ZN_FILIAL,1,4) '
      ' Where Empresa = '#39'0201'#39
      ' AND ZN.ZN_TIPO = 1 '
      ' AND ZN_ESPECIF <> '#39#39
      ' AND ID = '#39'B36C'#39') TB '
      'Order by TipoEspecificacao, Ordem, Medida')
    Left = 365
    Top = 289
    object Query_RelatorioTipoEspecificacao: TStringField
      FieldName = 'TipoEspecificacao'
      ReadOnly = True
      Size = 7
    end
    object Query_RelatorioID: TStringField
      FieldName = 'ID'
      Size = 4
    end
    object Query_RelatorioItem: TStringField
      FieldName = 'Item'
      Size = 50
    end
    object Query_RelatorioGrupo: TStringField
      FieldName = 'Grupo'
      Size = 50
    end
    object Query_RelatorioTipo: TStringField
      FieldName = 'Tipo'
      Size = 8
    end
    object Query_RelatorioTamanho: TStringField
      FieldName = 'Tamanho'
      Size = 8
    end
    object Query_RelatorioFormato: TStringField
      FieldName = 'Formato'
      Size = 10
    end
    object Query_RelatorioOrdem: TStringField
      FieldName = 'Ordem'
      Size = 2
    end
    object Query_RelatorioMedida: TStringField
      FieldName = 'Medida'
      Size = 100
    end
    object Query_RelatorioUnidade: TStringField
      FieldName = 'Unidade'
      ReadOnly = True
      Size = 2
    end
    object Query_RelatorioEspecificacao: TStringField
      FieldName = 'Especificacao'
      Size = 10
    end
    object Query_RelatorioVariacao: TStringField
      FieldName = 'Variacao'
      Size = 10
    end
    object Query_RelatorioMinino: TStringField
      FieldName = 'Minino'
      Size = 10
    end
    object Query_RelatorioMaximo: TStringField
      FieldName = 'Maximo'
      Size = 10
    end
  end
