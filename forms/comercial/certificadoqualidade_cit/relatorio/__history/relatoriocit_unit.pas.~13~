...
begin
  ...
  begin
      Application.MessageBox('Data Inicial não pode ser maior do que a Data Final','Atenção',mb_iconwarning + mb_ok);
  ...
  begin
     ...
     ppLBL_Periodo.Caption :=  ' Data de Saída Entre ' + ' ' + DateToStr(DT_DataSaida1.Date) + ' a ' + DateToStr(DT_DataSaida2.Date);
...
begin
  inherited;
  ppLBL_NumeroPagina.Caption := ('Página ' + IntToStr(ppCIT.Page) + ' de ' + IntToStr(ppCIT.PageCount));
end;
