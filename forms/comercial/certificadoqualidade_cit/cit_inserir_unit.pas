...
// Validação **********************************************************************************************************
  ...
  begin
       Application.MessageBox('Campo Obrigatório: Defina a Lacre 01!' + #13 + '','Atenção',mb_iconerror + mb_ok);
  ...
  begin
       Application.MessageBox('Campo Obrigatório: Defina a Transportadora!' + #13 + '','Atenção',mb_iconerror + mb_ok);
       Exit;
  end;

  if TXT_MotoristaID.Text = '' then
  begin
       Application.MessageBox('Campo Obrigatório: Defina o Motorista!' + #13 + '','Atenção',mb_iconerror + mb_ok);
       Exit;
  end;
  ...
  Application.MessageBox('Cit Gerada com Sucesso!','Atenção',mb_iconwarning + mb_ok);
...
begin
  ...
  begin
       Application.MessageBox('Já existe nota vinculada na CIT para esta Transportadora!' + #13 + '','Atenção',mb_iconerror + mb_ok);
       Exit;
  end;
...
// Validação **********************************************************************************************************
  ...
  if (CDS_CITItens.Active = True) AND (DS_CITItens.DataSet.RecordCount > 0) then
  begin
       Application.MessageBox('Já existe nota vinculada na CIT para este Motorista!' + #13 + '','Atenção',mb_iconerror + mb_ok);
       Exit;
  end;
