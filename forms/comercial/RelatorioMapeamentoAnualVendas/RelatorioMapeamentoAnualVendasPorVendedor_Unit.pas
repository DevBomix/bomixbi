unit RelatorioMapeamentoAnualVendasPorVendedor_Unit;
...
type
  TRelatorioMapaAnualVendasPorVendedor = class(TForm)
    CDS: TClientDataSet;
    Query: TADOQuery;
    DS: TDataSource;
...
var
  RelatorioMapaAnualVendasPorVendedor: TRelatorioMapaAnualVendasPorVendedor;
...
procedure TRelatorioMapaAnualVendasPorVendedor.ConsultarSQL;
Var
   VLC_Select : String;
begin
...
procedure TRelatorioMapaAnualVendasPorVendedor.ExportarExcel;
...
procedure TRelatorioMapaAnualVendasPorVendedor.Image2Click(Sender: TObject);
begin
  ConsultarSQL;
  ExportarExcel;
  Close;
...
procedure TRelatorioMapaAnualVendasPorVendedor.ImprimirRelatorio;
begin
