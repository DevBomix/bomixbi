object RelatorioMapaAnualVendasPorVendedor: TRelatorioMapaAnualVendasPorVendedor
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Mapeamento Anual de Vendas Por Vendedor'
  ClientHeight = 301
  ClientWidth = 283
  Color = 16384
  ...
  object CDS: TClientDataSet
    ...
    object CDSJaneiro: TIntegerField
      FieldName = 'Janeiro'
      ReadOnly = True
    end
    object CDSFevereiro: TIntegerField
      FieldName = 'Fevereiro'
      ReadOnly = True
    end
    object CDSMarco: TIntegerField
      FieldName = 'Marco'
      ReadOnly = True
    end
    object CDSAbril: TIntegerField
      FieldName = 'Abril'
      ReadOnly = True
    end
    object CDSMaio: TIntegerField
      FieldName = 'Maio'
      ReadOnly = True
    end
    object CDSJunho: TIntegerField
      FieldName = 'Junho'
      ReadOnly = True
    end
    object CDSJulho: TIntegerField
      FieldName = 'Julho'
      ReadOnly = True
    end
    object CDSAgosto: TIntegerField
      FieldName = 'Agosto'
      ReadOnly = True
    end
    object CDSSetembro: TIntegerField
      FieldName = 'Setembro'
      ReadOnly = True
    end
    object CDSOutubro: TIntegerField
      FieldName = 'Outubro'
      ReadOnly = True
    end
    object CDSNovembro: TIntegerField
      FieldName = 'Novembro'
      ReadOnly = True
    end
    object CDSDezembro: TIntegerField
      FieldName = 'Dezembro'
      ReadOnly = True
    end
    object CDSTotalQuantidade: TIntegerField
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ...
      '   '
        ...
        'ao, '
      ' '#9#9#9#9'SUM(Quantidade) as Quantidade  '
      '   '
      ' '#9#9#9'  FROM (   '
      '    '
      ' '#9#9#9#9#9'SELECT   '
    ...
    object QueryJaneiro: TIntegerField
      FieldName = 'Janeiro'
      ReadOnly = True
    end
    object QueryFevereiro: TIntegerField
      FieldName = 'Fevereiro'
      ReadOnly = True
    end
    object QueryMarco: TIntegerField
      FieldName = 'Marco'
      ReadOnly = True
    end
    object QueryAbril: TIntegerField
      FieldName = 'Abril'
      ReadOnly = True
    end
    object QueryMaio: TIntegerField
      FieldName = 'Maio'
      ReadOnly = True
    end
    object QueryJunho: TIntegerField
      FieldName = 'Junho'
      ReadOnly = True
    end
    object QueryJulho: TIntegerField
      FieldName = 'Julho'
      ReadOnly = True
    end
    object QueryAgosto: TIntegerField
      FieldName = 'Agosto'
      ReadOnly = True
    end
    object QuerySetembro: TIntegerField
      FieldName = 'Setembro'
      ReadOnly = True
    end
    object QueryOutubro: TIntegerField
      FieldName = 'Outubro'
      ReadOnly = True
    end
    object QueryNovembro: TIntegerField
      FieldName = 'Novembro'
      ReadOnly = True
    end
    object QueryDezembro: TIntegerField
      FieldName = 'Dezembro'
      ReadOnly = True
    end
    object QueryTotalQuantidade: TIntegerField
      FieldName = 'TotalQuantidade'
      ReadOnly = True
    end
  end
