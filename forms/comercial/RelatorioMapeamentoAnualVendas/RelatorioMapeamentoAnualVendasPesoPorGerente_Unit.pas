unit RelatorioMapeamentoAnualVendasPesoPorGerente_Unit;
...
type
  TRelatorioMapaAnualVendasPesoPorGerente = class(TForm)
    CDS: TClientDataSet;
    Query: TADOQuery;
    DS: TDataSource;
...
var
  RelatorioMapaAnualVendasPesoPorGerente: TRelatorioMapaAnualVendasPesoPorGerente;
...
procedure TRelatorioMapaAnualVendasPesoPorGerente.ConsultarSQL;
Var
   VLC_Select : String;
begin
  VLC_Select := VLC_Select + '  Select  ' + #13;
   ...
   VLC_Select := VLC_Select + ' Select ' + #13;
   VLC_Select := VLC_Select + '   ' + #13;
   VLC_Select := VLC_Select + '	Cliente_ID + ' + '''' + ' - ' + '''' + ' + Loja + ' + '''' + ' - ' + '''' + ' + Cliente as Cliente, UF, SetorMercado, GrupoPrincipal, Personalizacao, Gerente, Ano,  ' + #13;
   ...
   VLC_Select := VLC_Select + ' 			SELECT   ' + #13;
   VLC_Select := VLC_Select + '   ' + #13;
   VLC_Select := VLC_Select + ' 				Ano, Mes, Gerente, Cliente_ID, Loja, Cliente, UF, Cidade, SetorMercado, GrupoPrincipal, Personalizacao,  ' + #13;
   VLC_Select := VLC_Select + ' 				SUM(Peso) as Quantidade  ' + #13;
   VLC_Select := VLC_Select + '   ' + #13;
   VLC_Select := VLC_Select + ' 			  FROM (   ' + #13;
   VLC_Select := VLC_Select + '    ' + #13;
   VLC_Select := VLC_Select + ' 					SELECT   ' + #13;
   VLC_Select := VLC_Select + ' 					ComissaoVendedor, Ano, Mes, Gerente, Cliente_ID, Loja, Cliente, UF, Cidade,  Rtrim(SetorMercado) as SetorMercado, GrupoPrincipal, Personalizacao, Max(Emissao) as UltimaCompra, ' + #13;
   ...
   VLC_Select := VLC_Select + ' 				Group by ComissaoVendedor, Ano, Mes, Gerente, Cliente_ID, Loja, Cliente, UF, Cidade, SetorMercado, GrupoPrincipal, Personalizacao    ' + #13;
   VLC_Select := VLC_Select + '      ' + #13;
   VLC_Select := VLC_Select + ' 			) TB Group by ComissaoVendedor,  Ano, Mes, Gerente, Cliente_ID, Loja, Cliente, UF, Cidade, SetorMercado, GrupoPrincipal, Personalizacao   ' + #13;
   VLC_Select := VLC_Select + '  ' + #13;
...
procedure TRelatorioMapaAnualVendasPesoPorGerente.ExportarExcel;
...
procedure TRelatorioMapaAnualVendasPesoPorGerente.Image2Click(Sender: TObject);
begin
  ConsultarSQL;
  ExportarExcel;
  Close;
...
procedure TRelatorioMapaAnualVendasPesoPorGerente.ImprimirRelatorio;
begin
