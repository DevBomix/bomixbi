inherited Relatorio_FaturamentoPeriodico: TRelatorio_FaturamentoPeriodico
  Caption = 'Faturamento Peri'#243'dico'
  ClientHeight = 284
  ClientWidth = 686
  OnShow = FormShow
  ExplicitWidth = 692
  ...
  object Panel4: TPanel [3]
    ...
    object CBX_TipoRelatorio: TComboBox
      ...
      ParentFont = False
      TabOrder = 1
      Text = 'RELAT'#211'RIO DE FATURAMENTO - DI'#193'RIO'
      Items.Strings = (
        'RELAT'#211'RIO DE FATURAMENTO - DI'#193'RIO'
        'RELAT'#211'RIO DE FATURAMENTO - MENSAL')
    end
  end
  ...
  object CDS: TClientDataSet
    ...
    object CDSDia: TIntegerField
      FieldName = 'Dia'
      ReadOnly = True
    end
    object CDSDiaExtenso: TStringField
      FieldName = 'DiaExtenso'
      ReadOnly = True
    end
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ' Select '
      '   Ano, Mes, Dia, DiaExtenso, Emissao, '
      
        '   Sum(Peso) as Peso, SUM(ValorLiquido) as ValorLiquido, SUM(Val' +
        'orPCC) as ValorPCC,'
      
        ' '#9'SUM(ValorBruto) as ValorBruto, Round((SUM(ValorPCC) / Sum(Peso' +
        ')),2) as Media '
      ' from ( '
      #9#9'Select'#9'ComissaoVendedor, Dia, Mes, DiaExtenso, Ano, Emissao, '
      
        #9#9'        (CASE WHEN ComissaoVendedor = '#39'Subtrai'#39' THEN -1 * SUM(' +
        'Peso) ELSE SUM(Peso) END) as Peso, '
      
        #9#9'        (CASE WHEN ComissaoVendedor = '#39'Subtrai'#39' THEN -1 * SUM(' +
        'ValorLiquido) ELSE SUM(ValorLiquido) END) as ValorLiquido, '
      
        #9#9'        (CASE WHEN ComissaoVendedor = '#39'Subtrai'#39' THEN -1 * SUM(' +
        'ValorPCC) ELSE SUM(ValorPCC) END) as ValorPCC, '
      
        #9#9'        (CASE WHEN ComissaoVendedor = '#39'Subtrai'#39' THEN -1 * SUM(' +
        'ValorBruto) ELSE SUM(ValorBruto) END) as ValorBruto '
      #9#9'from ( '
      '    Select * from BomixBI.dbo.Fat_TB_NotaFiscalVenda Nota '
      
        '    Inner Join BomixBI.dbo.Fat_TB_NotaFiscalVendaItem Item On No' +
        'ta.F2_Recno = Item.F2_RecnoFK'
      
        #9#9'Where Emissao Between '#39'2018-09-26 00:00:00'#39' AND '#39'2018-10-25 23' +
        ':59:00'#39
      ...
      #9#9#9#9#9'Union All '
        ...
        '    Select * from BomixBI.dbo.Fat_TB_NotaFiscalVendaDevolucao De' +
        'volucao'
      
        '    Inner Join BomixBI.dbo.Fat_TB_NotaFiscalVendaDevolucaoItem I' +
        'tem On Devolucao.F2_Recno = Item.F2_RecnoFK'
      ...
      ''
      #9#9') TB '
      #9#9'Group by Dia, Mes, DiaExtenso, Ano, Emissao, ComissaoVendedor '
      ''
      ' ) TB'
      ' Group by Ano, Mes, Dia, DiaExtenso, Emissao'
      ' Order by Emissao ')
    Left = 283
    Top = 242
    ...
    object QueryDia: TIntegerField
      FieldName = 'Dia'
      ReadOnly = True
    end
    object QueryDiaExtenso: TStringField
      FieldName = 'DiaExtenso'
      ReadOnly = True
    end
  ...
  object ppReportDiario: TppReport
    ...
    object ppHeaderBand16: TppHeaderBand
      ...
      object ppLabel278: TppLabel
        ...
        Border.mmPadding = 0
        Caption = 'Relat'#243'rio de Faturamento - Di'#225'rio'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 18
    ...
    object ppGroup2: TppGroup
      ...
      object ppGroupHeaderBand2: TppGroupHeaderBand
        ...
        object Linha_GerenciaXGerencia03: TppLine
          DesignLayer = ppDesignLayer1
          UserName = 'Line8'
          Border.mmPadding = 0
          Position = lpLeft
        ...
        object ppLabel5: TppLabel
          DesignLayer = ppDesignLayer1
          UserName = 'LBL_QTDGerenciaXGerencia2'
          HyperlinkEnabled = False
          AutoSize = False
          Border.mmPadding = 0
          Caption = '/'
      ...
      object ppGroupFooterBand2: TppGroupFooterBand
        ...
        object TXT_ValorTotalPCC1: TppDBCalc
          DesignLayer = ppDesignLayer1
          UserName = 'TXT_ValorTotalPCC1'
          HyperlinkEnabled = False
          Border.mmPadding = 0
          DataField = 'ValorPCC'
          DataPipeline = ppDB
  ...
  object ppReportMensal: TppReport
    AutoStop = False
    ColumnPositions.Strings = (
      '6350'
      '105001')
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel6: TppLabel
        ...
        HyperlinkEnabled = False
        Border.mmPadding = 0
        Caption = 'Relat'#243'rio Peri'#243'dico - Mensal'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 18
  ...
  object ppDBPipeline1: TppDBPipeline
    DataSource = DS_Mensal
    CloseDataSource = True
    UserName = 'ppDBPipeline_RelatorioMensal'
    Left = 52
    Top = 296
  ...
  object Query_Mensal: TADOQuery
    ...
    SQL.Strings = (
      ' Select '
      '   Ano, Mes, Dia, DiaExtenso,  '
      
        '   Emissao, Sum(Peso) as Peso, SUM(ValorLiquido) as ValorLiquido' +
        ',  SUM(ValorPCC) as ValorPCC,'
  ...
  object DS_Mensal: TDataSource
    DataSet = CDS_Mensal
    Left = 313
    Top = 297
  end
  object DSP_Mensal: TDataSetProvider
    DataSet = Query_Mensal
    Left = 344
    Top = 297
  end
end
