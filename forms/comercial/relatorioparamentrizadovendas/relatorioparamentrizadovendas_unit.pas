...
// Data: 23/07/2010
// Função: Retorna o final do Agrupamento do totalizador final
// *****************************************************************************************************************************
function TRelatorioParametrizadoVendas.OrderPadraoTotalizadorGeral: String;
begin
    VPC_QueryOrder := ' Group By ComissaoVendedor Having ComissaoVendedor <> ' + '''' + 'Não Altera' + '''' + ') TB Group By ComissaoVendedor) TBPrincipal';
...
// Data: 23/07/2010
// Função: Executa Totalizador Geral do relatorio
// *****************************************************************************************************************************
...
begin
   ...
   begin
        If GetCombinacaoQuebras = 'GERÊNCIAXGERÊNCIA'       Then   begin  FazerCalculoTotalizador(RelatorioParametrizadoVendas_GerenciaXGerencia.CDS_GerenciaXGerencia)     end;
        If GetCombinacaoQuebras = 'GERÊNCIAXVENDEDOR'       Then   begin  FazerCalculoTotalizador(CDS_GerenciaXVendedor)                                                    end;
        If GetCombinacaoQuebras = 'GERÊNCIAXCLIENTE'        Then   begin  FazerCalculoTotalizador(CDS_GerenciaXCliente)                                                     end;
        If GetCombinacaoQuebras = 'GERÊNCIAXPEDIDO/NOTA'    Then   begin  FazerCalculoTotalizador(CDS_GerenciaXNota)                                                        end;
        If GetCombinacaoQuebras = 'GERÊNCIAXITEM'           Then   begin  FazerCalculoTotalizador(CDS_GerenciaXItem)                                                        end;
        If GetCombinacaoQuebras = 'GERÊNCIAXSEGMENTO'       Then   begin  FazerCalculoTotalizador(RelatorioParametrizadoVendas_GerenciaXSegmento.CDS_GerenciaXSegmento)     end;
        ...
        If GetCombinacaoQuebras = 'ITEMXGERÊNCIA'           Then   begin  FazerCalculoTotalizador(CDS_ItemXGerencia)                                                        end;
...
// Data: 23/07/2010
// Função: Une as Quebras determinadas pelo usuario
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Verifica se o usuário não digitou alguma quebra inexistente da pre-configuração
// *****************************************************************************************************************************
function TRelatorioParametrizadoVendas.VerificarValidadeDasQuebras: Boolean;
begin

   If ((CB_PrimeiraQuebra.Text = 'GERÊNCIA')
   ...
   begin
         If ((CB_SegundaQuebra.Text = 'GERÊNCIA')
...
// Data: 23/07/2010
// Função: Retorna as Opções dos Filtros Determinada pelo Usuário
// *****************************************************************************************************************************
...
begin
  ...
  If PadraoBuscadorFiltro.RetornarWhereFiltro(CB_Operador_Periodo,PNL_Periodo,TXT_Valor1_Periodo,TXT_Valor2_Periodo,'Emissao','Data') <> '' then
     begin
        ...
        VPC_FiltroPesquisa := VPC_FiltroPesquisa + ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text + ';';
     end;
...

{
  ...
  If PadraoBuscadorFiltro.RetornarWhereFiltro(CB_Operador_Comissao,PNL_Comissao,TXT_Valor1_Comissao,TXT_Valor2_Comissao,'ComissaoVendedor','Caracter') <> '' then
     begin
        ...
        begin
             CB_Operador_Comissao.Text := 'Está contido';
             VPC_FiltroPesquisa := VPC_FiltroPesquisa + ' Comissão ' + CB_Operador_Comissao.Text + ' ' + CBX_Valor1_Comissao.Text + ' ' + TXT_Valor2_Comissao.Text + ';';
        ...
        begin
             VPC_QueryWhere := VPC_QueryWhere + ' AND ' +  PadraoBuscadorFiltro.RetornarWhereFiltro(CB_Operador_Comissao,PNL_Comissao,TXT_Valor1_Comissao,TXT_Valor2_Comissao,'ComissaoVendedor','Caracter') + #13;
             VPC_FiltroPesquisa := VPC_FiltroPesquisa + ' Comissão ' + CB_Operador_Comissao.Text + ' ' + TXT_Valor1_Comissao.Text + ' ' + TXT_Valor2_Comissao.Text + ';';
        end;
     end;
  ...
  If PadraoBuscadorFiltro.RetornarWhereFiltro(CB_Operador_TipoRotulagem,PNL_TipoRotulagem,TXT_Valor1_TipoRotulagem,TXT_Valor2_TipoRotulagem,'TipoProduto','Caracter') <> '' then
     begin
        ...
        begin
             CB_Operador_TipoRotulagem.Text := 'Está contido';
  ...
  if CBX_ListarTipoAlcaSimples.Enabled = True then
     begin
        ...
        VPC_FiltroPesquisa := VPC_FiltroPesquisa + ' Tipo de Alça ' + '''' + CBX_ListarTipoAlcaSimples.Text + '''';
     end;
  ...
  begin
     ...
     begin
        ...
        VPC_FiltroPesquisa := VPC_FiltroPesquisa + ' Personalização ' + '''' + CBX_ListarTipoRotulagemSimples.Text + '''';
     end;
  end;
...
// Rotina: SelectPadrao
// Data: 23/07/2010
// Função: Retorna a select central que listará todos os campos relacionado ao Parametrizado para depois ser unido com os Agrupamentos
// especificos de cada combinação. exemplo: Item x Item, Nota x Item e ect
// *****************************************************************************************************************************
...
//  VPC_QuerySelect := VPC_QuerySelect + '      						                              AND Item.D2_Empresa = Nota.F2_Empresa' + #13;
  ...
  VPC_QuerySelect := VPC_QuerySelect + '		AND Item.Faturamento <> ' + '''' +  'Não Comercial' + '''' + #13;
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Gerência x Gerência
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Gerencia x Gerencia
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Gerencia x Vendedor
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Gerencia x Cliente
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Gerencia x Nota
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Supervisor x Item
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Gerencia x Item
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Vendedor x Vendedor
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Vendedor x Cliente
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Vendedor x Nota
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Vendedor x Item
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Cliente x Cliente
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Cliente x Nota
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Cliente x Item
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna a Select da Configuração Cliente x Item
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna a Select da Configuração Cliente x Nota/Itens
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Cliente x Nota/Itens
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Nota x Nota
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna a Select da Configuração Nota x Nota
// *****************************************************************************************************************************
...
// Data: 26/07/2010
// Função: Retorna o Ordenamento da Opção Nota x Item
// *****************************************************************************************************************************
...
// Data: 26/07/2010
// Função: Retorna a Select da Configuração Nota x Item
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna a Select da Configuração Item x Item
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Item x Item
// *****************************************************************************************************************************
...
// Data: 23/06/2020
// Função: Retorna a Select da Configuração Segmento x Segmento
// *****************************************************************************************************************************
...
// Rotina: ItemXItemOrder
// Data: 23/06/2020
// Função: Retorna o Ordenamento da Opção Segmento x Segmento
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna a Select da Configuração Item x Cliente
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Item x Cliente
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna a Select da Configuração Item x Nota
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Item x Nota
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna a Select da Configuração Item x Gerencia
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Item x Gerencia
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna a Select da Configuração Item x Vendedor
// *****************************************************************************************************************************
...
// Data: 23/07/2010
// Função: Retorna o Ordenamento da Opção Item x Vendedor
// *****************************************************************************************************************************
...
begin
   ...
   If CB_PrimeiraQuebra.Text = 'GERÊNCIA' then
   begin
       CB_SegundaQuebra.Items.Clear;
       CB_SegundaQuebra.Items.Add('GERÊNCIA');
       ...
       CB_SegundaQuebra.Text := 'GERÊNCIA';
       Exit;
   end;
...
// Data: 27/06/2011
// Função: Executa o Relatorio Gerência x Gerência
// *****************************************************************************************************************************
...
begin
    ...
    try
          ...
          begin
              ...
              RelatorioParametrizadoVendas_GerenciaXGerencia.ppLBL_PeriodoGerenciaXGerencia.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
            ...
            begin
                ...
                ppLBL_PeriodoGerenciaXVendedor.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
            ...
            begin
                ...
                ppLBL_PeriodoGerenciaXCliente.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
// Data: 02/08/2020
// Função: Retorna o Ordenamento da Opção Gerencia x Segmento
// *****************************************************************************************************************************
...
begin
    ...
    try
            ...
            begin
                ...
                RelatorioParametrizadoVendas_GerenciaXSegmento.ppLBL_PeriodoGerenciaXSegmento.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoGerenciaXNota.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoGerenciaXItem.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoVendedorXVendedor.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoVendedorXCliente.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoVendedorXNota.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoVendedorXItem.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
//    CBX_ListarComissaoSimplesChange(nil);
    ...
    begin
        ...
        ppLBL_PeriodoClienteXCliente.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoClienteXNotaItens.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoClienteXNota.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoClienteXItem.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoNotaXNota.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoNotaXItem.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoItemXGerencia.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_DataItemXVendedor.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoItemXCliente.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    CBX_ListarComissaoSimplesChange(nil);
            ...
            begin
                ...
                ppLBL_PeriodoItemXNota.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    try
            ...
            begin
                ...
                RelatorioParamentrizadoVendas_Segmento_X_Segmento.ppLBL_PeriodoSegmentoXSegmento.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
    ...
    try
            ...
            begin
                ...
                RelatorioParamentrizadoVendas_Item_X_Item.ppLBL_PeriodoItemXItem.Caption :=  ' Período ' + CB_Operador_Periodo.Text + ' ' + TXT_Valor1_Periodo.Text + ' a ' + TXT_Valor2_Periodo.Text;
...
begin
  ...
  // Validação das Datas
   ...
   begin
      Application.MessageBox('A data final não pode ser menor que a data inicial' + #13 + 'Consulte o Administrador do sistema','Atenção',mb_iconwarning + mb_ok);
   ...
   begin
        ...
        If GetCombinacaoQuebras = 'GERÊNCIAXGERÊNCIA'       Then   begin  ExecuteGerenciaXGerencia;       Exit; end;
        If GetCombinacaoQuebras = 'GERÊNCIAXVENDEDOR'       Then   begin  ExecuteGerenciaXVendedor;       Exit; end;
        If GetCombinacaoQuebras = 'GERÊNCIAXCLIENTE'        Then   begin  ExecuteGerenciaXCliente;        Exit; end;
        If GetCombinacaoQuebras = 'GERÊNCIAXPEDIDO/NOTA'    Then   begin  ExecuteGerenciaXNota;           Exit; end;
        If GetCombinacaoQuebras = 'GERÊNCIAXITEM'           Then   begin  ExecuteGerenciaXItem;           Exit; end;
        If GetCombinacaoQuebras = 'GERÊNCIAXSEGMENTO'       Then   begin  ExecuteGerenciaXSegmento;       Exit; end;
        ...
        If GetCombinacaoQuebras = 'ITEMXGERÊNCIA'           Then   begin  ExecuteItemXGerencia;           Exit; end;
   ...
   begin
        Application.MessageBox('Selecione apenas as quebras determinada pelo sistema!','Atenção',mb_iconwarning + mb_ok);
...
procedure TRelatorioParametrizadoVendas.ppNotaxNotaStartPage(
  Sender: TObject);
begin
  ppLBL_DataNotaXNota.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaNotaXNota.Caption := ('Página ' + IntToStr(ppNotaXNota.Page) + ' de ' + IntToStr(ppNotaXNota.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
  begin
       ppTituloNotaXNota.Caption := 'Relatório Parametrizado de Pedidos (Pedido x Pedido)';
       ppLabel39.Caption := 'Pedido';
  end
  else
  begin
       ppTituloNotaXNota.Caption := 'Relatório Parametrizado de Notas (Nota x Nota)';
...
begin
  ...
  ppLBL_DataNotaXItem.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaNotaXItem.Caption := ('Página ' + IntToStr(ppNotaXItem.Page) + ' de ' + IntToStr(ppNotaXItem.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel24.Caption := 'Relatório Parametrizado de Pedidos (Nota x Item)'
  else
       ppLabel24.Caption := 'Relatório Parametrizado de Vendas (Nota x Item)';
...
begin
  ...
  ppLBL_DataClienteXNotaItens.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_UsuarioClienteXNotaItens.Caption := 'Usuário: ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;
  ppLBL_NumeroPaginaClienteXNotaItens.Caption := ('Página ' + IntToStr(ppClienteXNota.Page) + ' de ' + IntToStr(ppClienteXNota.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
  begin
       ppLabel65.Caption := 'Relatório Parametrizado de Pedidos (Cliente x Nota/Itens)';
       ppLabel90.Caption := 'Pedido';
  end
  else
  begin
       ppLabel65.Caption := 'Relatório Parametrizado de Vendas (Cliente x Nota/Itens)';
...
procedure TRelatorioParametrizadoVendas.ppClienteXNotaStartPage(
  Sender: TObject);
begin
  ppLBL_DataClienteXNota.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaClienteXNota.Caption := ('Página ' + IntToStr(ppClienteXNota.Page) + ' de ' + IntToStr(ppClienteXNota.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
  begin
       ppLabel66.Caption := 'Relatório Parametrizado de Pedidos (Cliente x Pedido)';
       ppLabel105.Caption := 'Pedido';
  end
  else
  begin
       ppLabel66.Caption := 'Relatório Parametrizado de Vendas (Cliente x Nota)';
...
begin
  ...
  ppLBL_DataClienteXItem.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaClienteXItem.Caption := ('Página ' + IntToStr(ppClienteXItem.Page) + ' de ' + IntToStr(ppClienteXItem.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel103.Caption := 'Relatório Parametrizado de Pedidos (Cliente x Item)'
  else
       ppLabel103.Caption := 'Relatório Parametrizado de Vendas (Cliente x Item)';
...
begin
  ...
  ppLBL_DataClienteXCliente.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaClienteXCliente.Caption := ('Página ' + IntToStr(ppClienteXCliente.Page) + ' de ' + IntToStr(ppClienteXCliente.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel111.Caption := 'Relatório Parametrizado de Pedidos (Cliente x Cliente)'
  else
       ppLabel111.Caption := 'Relatório Parametrizado de Vendas (Cliente x Cliente)';
end;
...
begin
  ...
  ppLBL_DataVendedorXItem.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaVendedorXItem.Caption := ('Página ' + IntToStr(ppVendedorXItem.Page) + ' de ' + IntToStr(ppVendedorXItem.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel112.Caption := 'Relatório Parametrizado de Pedidos (Vendedor x Item)'
  else
       ppLabel112.Caption := 'Relatório Parametrizado de Vendas (Vendedor x Item)';
...
begin
  ...
  ppLBL_DataVendedorXNota.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaVendedorXNota.Caption := ('Página ' + IntToStr(ppVendedorXNota.Page) + ' de ' + IntToStr(ppVendedorXNota.PageCount));
...
begin
  ...
  ppLBL_DataVendedorXCliente.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaVendedorXCliente.Caption := ('Página ' + IntToStr(ppVendedorXCliente.Page) + ' de ' + IntToStr(ppVendedorXCliente.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel194.Caption := 'Relatório Parametrizado de Pedidos (Vendedor x Cliente)'
  else
       ppLabel194.Caption := 'Relatório Parametrizado de Vendas (Vendedor x Cliente)';
...
begin
  ...
  ppLBL_DataVendedorXVendedor.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaVendedorXVendedor.Caption := ('Página ' + IntToStr(ppVendedorXVendedor.Page) + ' de ' + IntToStr(ppVendedorXVendedor.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel196.Caption := 'Relatório Parametrizado de Pedidos (Vendedor x Vendedor)'
  else
       ppLabel196.Caption := 'Relatório Parametrizado de Vendas (Vendedor x Vendedor)';
end;
...
begin
  ...
  ppLBL_DataGerenciaXVendedor.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaGerenciaXVendedor.Caption := ('Página ' + IntToStr(ppGerenciaXVendedor.Page) + ' de ' + IntToStr(ppGerenciaXVendedor.PageCount));
  LBL_UsuarioGerenciaXVendedor.Caption := Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel198.Caption := 'Relatório Parametrizado de Pedidos (Gerência x Vendedor)'
  else
       ppLabel198.Caption := 'Relatório Parametrizado de Notas (Gerência x Vendedor)';
...
begin
  ...
  ppLBL_DataGerenciaXCliente.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaGerenciaXCliente.Caption := ('Página ' + IntToStr(ppGerenciaXCliente.Page) + ' de ' + IntToStr(ppGerenciaXCliente.PageCount));
  LBL_UsuarioGerenciaXCliente.Caption := Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel310.Caption := 'Relatório Parametrizado de Pedidos (Gerência x Cliente)'
  else
       ppLabel310.Caption := 'Relatório Parametrizado de Notas (Gerência x Cliente)';
...
begin
  ...
  ppLBL_DataGerenciaXNota.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_UsuarioGerenciaXNota.Caption := 'Usuário: ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;
  ppLBL_NumeroPaginaGerenciaXNota.Caption := ('Página ' + IntToStr(ppGerenciaXNota.Page) + ' de ' + IntToStr(ppGerenciaXNota.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
  begin
       ppLabel366.Caption := 'Relatório Parametrizado de Pedidos (Gerência x Pedido)';
       ppLabel380.Caption := 'Pedido';
  end
  else
  begin
       ppLabel366.Caption := 'Relatório Parametrizado de Notas (Gerência x Nota)';
...
begin
  ...
  ppLBL_DataGerenciaXItem.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaGerenciaXItem.Caption := ('Página ' + IntToStr(ppGerenciaXItem.Page) + ' de ' + IntToStr(ppGerenciaXItem.PageCount));
  LBL_UsuarioGerenciaXItem.Caption := 'Usuário: ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;

   if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel432.Caption := 'Relatório Parametrizado de Pedidos (Gerência x Item)'
  else
       ppLabel432.Caption := 'Relatório Parametrizado de Notas (Gerência x Item)';
end;
...
begin
    ...
    begin
        CDS_ListarClientes.Close;
        CB_Operador_Cliente.Text := 'Contém';
...
begin
    ...
    begin
        ...
        CDS_ListarGerencia.Close;
        CB_Operador_Gerente.Text := 'Contém';
...
begin
    ...
    begin
        ...
        CDS_ListarGrupoItem.Close;
        CB_Operador_GrupoItem.Text := 'Contém';
...
begin
    ...
    begin
        ...
        CDS_ListarVendedor.Close;
        CB_Operador_Vendedor.Text := 'Contém';
...
begin
  ...
  ppLBL_DataItemXGerencia.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaItemXGerencia.Caption := ('Página ' + IntToStr(ppItemXGerencia.Page) + ' de ' + IntToStr(ppItemXGerencia.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel456.Caption := 'Relatório Parametrizado de Pedidos (Item x Gerência)'
  else
       ppLabel456.Caption := 'Relatório Parametrizado de Vendas (Item x Gerência)';
...
begin
  ...
  ppLBL_DataItemXVendedor.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaItemXVendedor.Caption := ('Página ' + IntToStr(ppItemXVendedor.Page) + ' de ' + IntToStr(ppItemXVendedor.PageCount));

  if CBX_TipoPedido.Text = 'PARAMETRIZADO DE PEDIDOS DE VENDA' then
       ppLabel45.Caption := 'Relatório Parametrizado de Pedidos (Item x Vendedor)'
  else
       ppLabel45.Caption := 'Relatório Parametrizado de Vendas (Item x Vendedor)';
...
begin
  ...
  ppLBL_DataItemXCliente.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaItemXCliente.Caption := ('Página ' + IntToStr(ppItemXCliente.Page) + ' de ' + IntToStr(ppItemXCliente.PageCount));
...
begin
  ...
  ppLBL_DataItemXNota.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaItemXNota.Caption := ('Página ' + IntToStr(ppItemXNota.Page) + ' de ' + IntToStr(ppItemXNota.PageCount));
