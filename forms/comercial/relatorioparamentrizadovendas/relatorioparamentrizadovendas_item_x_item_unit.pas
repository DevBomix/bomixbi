...
procedure TRelatorioParamentrizadoVendas_Item_X_Item.ppItemXItemStartPage(
  Sender: TObject);
begin
  ppLBL_DataItemXItem.Caption := 'Data Impressão: ' + DateTimeToStr(Date());
  ppLBL_NumeroPaginaItemXItem.Caption := ('Página ' + IntToStr(RelatorioParamentrizadoVendas_Item_X_Item.ppItemXItem.Page) + ' de ' + IntToStr(RelatorioParamentrizadoVendas_Item_X_Item.ppItemXItem.PageCount));
