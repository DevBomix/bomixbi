object Relatorio_ControleRotulos_PorCliente: TRelatorio_ControleRotulos_PorCliente
  Left = 0
  Top = 0
  Caption = 'Relatorio_ControleRotulos_PorCliente'
  ClientHeight = 277
  ClientWidth = 541
  Color = clBtnFace
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ''
      'Select '
      #9'Distinct Empresa, Cliente_ID, Loja, RazaoSocial, '
      #9'Cidade, UF, Vendedor_FK, Vendedor, Gerente, '#9#9#9
      #9'ID, Rotulo, '
      
        #9'Dados.SaldoTotal, Dados.QtdPedido, Dados.ProdutoAcabado, Dados.' +
        'SaldoReal'#9#9#9
      #9#9#9
      'from BomixBI.dbo.Pcp_TB_ProdutoRotulo Rot (nolock)  '
      'Inner Join ('
      ''
      #9#9#9#9'Select'
      
        '  '#9#9#9#9#9#9'ID as Rotulo_ID, SaldoTotal, QtdPedido, Sum(ProdutoAcaba' +
        'do) as ProdutoAcabado, SaldoReal'
      #9#9#9#9#9'from ( '
      #9#9#9#9#9#9#9#9'Select '
      #9#9#9#9#9#9#9#9#9'Distinct  '
      
        '                  '#9#9#9#9#9#9'Empresa, ID, Rotulo, Lote, DataValidade,' +
        ' Status, SaldoTotal, QtdOrcamento + QtdPedido as QtdPedido, Prod' +
        'utoAcabado, SaldoReal, '
      
        #9#9#9#9#9#9#9#9#9#9'Status_Comercial, DataValidade_Comercial, SaldoPorLote' +
        ', CompraNota, CompraEmissao, CompraQuantidade, CompraUM '
      #9#9#9#9#9#9#9#9'from BomixBI.dbo.Pcp_TB_ProdutoRotulo (nolock)  '
      #9#9#9#9#9#9#9#9'Where Empresa = '#39'0101'#39
      #9#9#9#9#9#9#9#9'AND Cliente_ID <> '#39'ZZZZZZ'#39
      #9#9#9#9#9#9#9#9'AND Vendedor_FK = '#39'000002'#39#9
      #9#9#9#9#9#9#9#9#9' '
      #9#9#9#9#9') TB  '
      
        #9#9#9#9'Group by ID, Rotulo, SaldoTotal, SaldoTotal, SaldoReal, QtdP' +
        'edido'#9
      ''
      ') Dados ON Dados.Rotulo_ID = Rot.ID'
      'Where Empresa = '#39'0101'#39#9
      'AND Cliente_ID <> '#39'ZZZZZZ'#39#9#9
      'AND Vendedor_FK = '#39'000002'#39#9#9
  ...
  object ppRelatorio: TppReport
    ...
    object ppHeaderBand5: TppHeaderBand
      ...
      object ppLabel33: TppLabel
        ...
        Caption = 'Rot'#250'los por Clientes'
