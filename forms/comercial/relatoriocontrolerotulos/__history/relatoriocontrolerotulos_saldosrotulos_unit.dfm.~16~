object Relatorio_ControleRotulos_SaldosRotulos: TRelatorio_ControleRotulos_SaldosRotulos
  Left = 0
  Top = 0
  Caption = 'Relatorio_ControleRotulos_SaldosRotulos'
  ClientHeight = 142
  ClientWidth = 417
  Color = clBtnFace
  ...
  object CDS: TClientDataSet
    ...
    object CDSCompraEmissao: TDateTimeField
      FieldName = 'CompraEmissao'
    end
    object CDSCompraQuantidade: TFloatField
      FieldName = 'CompraQuantidade'
    end
    object CDSCompraUM: TStringField
      FieldName = 'CompraUM'
      Size = 3
    end
    object CDSDataValidade_Comercial: TDateTimeField
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ...
      'Select '
        ...
        #9#9'Empresa, ID, Rotulo, Lote, DataValidade, Status, SaldoTotal, Q' +
        'tdPedido, Sum(ProdutoAcabado) as ProdutoAcabado, Sum(ProdutoAcab' +
        'ado) + SaldoReal as SaldoReal, '
      
        #9#9'Status_Comercial, DataValidade_Comercial, SaldoPorLote, Compra' +
        'Nota, CompraEmissao, CompraQuantidade, CompraUM '
      'from ('#9
      #9#9'Select '
      #9#9#9'Distinct  '
      
        #9#9#9#9'Empresa, ID, Rotulo, Lote, DataValidade, Status, SaldoTotal,' +
        ' QtdPedido, ProdutoAcabado, SaldoReal, '
      
        #9#9#9#9'Status_Comercial, DataValidade_Comercial, SaldoPorLote, Comp' +
        'raNota, CompraEmissao, CompraQuantidade, CompraUM '
      #9#9'from BomixBI.dbo.Pcp_TB_ProdutoRotulo (nolock)  '
      #9#9'Where Empresa = '#39'0101'#39#9#9
      ') TB'
      
        'Group by Empresa, ID, Rotulo, Lote, DataValidade, Status, SaldoT' +
        'otal, QtdPedido, SaldoReal, '
    ...
    object QueryCompraEmissao: TDateTimeField
      FieldName = 'CompraEmissao'
    end
    object QueryCompraQuantidade: TFloatField
      FieldName = 'CompraQuantidade'
    end
    object QueryCompraUM: TStringField
      FieldName = 'CompraUM'
      Size = 3
    end
    object QueryDataValidade_Comercial: TDateTimeField
      FieldName = 'DataValidade_Comercial'
    end
    ...
    object ppGroup2: TppGroup
      ...
      object ppGroupHeaderBand2: TppGroupHeaderBand
        ...
        object ppDBText13: TppDBText
          ...
          UserName = 'DBText101'
          Border.mmPadding = 0
          DataField = 'DataValidade_Comercial'
          DataPipeline = ppDBPipeline1
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Name = 'Arial'
