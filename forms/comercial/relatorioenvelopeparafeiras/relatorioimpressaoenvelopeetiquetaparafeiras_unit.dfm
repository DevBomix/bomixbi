inherited RelatorioImpressaoEnvelopeEtiquetaParaFeiras: TRelatorioImpressaoEnvelopeEtiquetaParaFeiras
  Caption = 'Imprimir Etiqueta\Envelope para Feiras'
  ClientHeight = 381
  OnShow = FormShow
  ExplicitHeight = 410
  PixelsPerInch = 96
  ...
  inherited Panel_Titulo: TPanel
    inherited LBL_Titulo: TLabel
      Width = 335
      Caption = 'Imprimir Etiqueta\Envelope p\ Feiras'
      ExplicitWidth = 335
    end
  end
  ...
  object Panel4: TPanel [4]
    ...
    object CBX_TipoRelatorio: TComboBox
      ...
      TabOrder = 1
      Text = 'ETIQUETA'
      OnChange = CBX_TipoRelatorioChange
      Items.Strings = (
        'ETIQUETA'
        'ENVELOPE'
        'LISTA DE CONTATOS')
  ...
  object Panel7: TPanel [9]
    ...
    ParentBackground = False
    TabOrder = 8
    object TXT_Valor2_ContatoID: TMaskEdit
      Left = 495
      Top = 4
      Width = 160
      Height = 23
    ...
    object CBX_OperadorContatoID: TComboBox
      Left = 197
      Top = 4
      Width = 134
      Height = 23
      ...
      TabStop = False
      Text = 'Cont'#233'm'
      OnChange = CBX_OperadorContatoIDChange
      Items.Strings = (
        'Iniciado por'
        'Igual'
        'Terminado por'
    ...
    object Panel8: TPanel
      ...
      ParentFont = False
      TabOrder = 1
      object PNL_SinalContatoID: TPanel
        Left = 174
        Top = 1
        Width = 13
        Height = 21
        ...
        ParentBackground = False
        TabOrder = 0
        OnClick = PNL_SinalContatoIDClick
      end
    end
    object CBX_Igual_ContatoID: TComboBox
      Left = 660
      Top = 4
      Width = 322
      Height = 23
    ...
    object TXT_Valor1_ContatoID: TMaskEdit
      Left = 334
      Top = 4
      Width = 159
      Height = 23
  ...
  object Panel26: TPanel [10]
    ...
    ParentBackground = False
    TabOrder = 9
    object TXT_Valor2_Contato: TMaskEdit
      Left = 495
      Top = 4
      Width = 160
      Height = 23
    ...
    object CBX_OperadorContato: TComboBox
      Left = 197
      Top = 4
      Width = 134
      Height = 23
      ...
      TabStop = False
      Text = 'Cont'#233'm'
      OnChange = CBX_OperadorContatoChange
      Items.Strings = (
        'Iniciado por'
        'Igual'
        'Terminado por'
    ...
    object Panel27: TPanel
      ...
      ParentFont = False
      TabOrder = 1
      object PNL_SinalContato: TPanel
        Left = 174
        Top = 1
        Width = 13
        Height = 21
        ...
        ParentBackground = False
        TabOrder = 0
        OnClick = PNL_SinalContatoClick
      end
    end
    object CBX_Igual_Contato: TComboBox
      Left = 660
      Top = 4
      Width = 322
      Height = 23
    ...
    object TXT_Valor1_Contato: TMaskEdit
      Left = 334
      Top = 4
      Width = 159
      Height = 23
  ...
  object ppDBPipeline1: TppDBPipeline
    DataSource = DS_Eventos
    CloseDataSource = True
    UserName = 'EtiquetaEvento'
    Left = 703
    Top = 253
  ...
  object Query_Eventos: TADOQuery
    Connection = Sys_ModuloConexaoDados.ADOConnection1
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * from BomixBI.dbo.Fat_VW_ClienteContato_Totvs '
      'where BMX_TB_ClienteContato.Abrafati = '#39'Sim'#39
      'Order By RazaoSocial')
    Left = 768
    Top = 254
    object Query_EventosCliente_ID: TStringField
      FieldName = 'Cliente_ID'
      ReadOnly = True
      Size = 6
    end
    object Query_EventosRazaoSocial: TStringField
      FieldName = 'RazaoSocial'
      ReadOnly = True
      Size = 40
    end
    object Query_EventosEndereco: TStringField
      FieldName = 'Endereco'
      ReadOnly = True
      Size = 72
    end
    object Query_EventosCidade: TStringField
      FieldName = 'Cidade'
      ReadOnly = True
      Size = 65
    end
    object Query_EventosCEP: TStringField
      FieldName = 'CEP'
      Size = 8
    end
    object Query_EventosContato_ID: TStringField
      FieldName = 'Contato_ID'
      Size = 6
    end
    object Query_EventosContato: TStringField
      FieldName = 'Contato'
      ReadOnly = True
      Size = 86
    end
    object Query_EventosAbrafati: TStringField
      FieldName = 'Abrafati'
      ReadOnly = True
      Size = 3
    end
    object Query_EventosFispal: TStringField
      FieldName = 'Fispal'
      ReadOnly = True
      Size = 3
    end
    object Query_EventosGerente: TStringField
      FieldName = 'Gerente'
      Size = 40
    end
  end
  ...
  object CDS_Eventos: TClientDataSet
    ...
    IndexDefs = <>
    Params = <>
    ProviderName = 'DSP_Eventos'
    StoreDefs = True
    Left = 828
    Top = 254
    object CDS_EventosCliente_ID: TStringField
      FieldName = 'Cliente_ID'
      ReadOnly = True
      Size = 6
    end
    object CDS_EventosRazaoSocial: TStringField
      FieldName = 'RazaoSocial'
      ReadOnly = True
      Size = 40
    end
    object CDS_EventosEndereco: TStringField
      FieldName = 'Endereco'
      ReadOnly = True
      Size = 72
    end
    object CDS_EventosCidade: TStringField
      FieldName = 'Cidade'
      ReadOnly = True
      Size = 65
    end
    object CDS_EventosCEP: TStringField
      FieldName = 'CEP'
      Size = 8
    end
    object CDS_EventosContato_ID: TStringField
      FieldName = 'Contato_ID'
      Size = 6
    end
    object CDS_EventosContato: TStringField
      FieldName = 'Contato'
      ReadOnly = True
      Size = 86
    end
    object CDS_EventosAbrafati: TStringField
      FieldName = 'Abrafati'
      ReadOnly = True
      Size = 3
    end
    object CDS_EventosFispal: TStringField
      FieldName = 'Fispal'
      ReadOnly = True
      Size = 3
    end
    object CDS_EventosGerente: TStringField
      FieldName = 'Gerente'
      Size = 40
    end
  end
  object ppDBPipeline2: TppDBPipeline
    DataSource = DS_Eventos
    CloseDataSource = True
    UserName = 'EnvelopeEvento'
    Left = 705
    Top = 293
  end
  object ppEnvelopeEvento: TppReport
    AutoStop = False
    DataPipeline = ppDBPipeline2
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    PrinterSetup.Orientation = poLandscape
    PrinterSetup.PaperName = 'Envelope #10'
    ...
    PrinterSetup.mmPaperHeight = 105000
    PrinterSetup.mmPaperWidth = 241000
    PrinterSetup.PaperSize = 20
    Template.FileName = 'C:\Bomix\ENVELOPE.rtm'
    Units = utMillimeters
  ...
  object DSP_Eventos: TDataSetProvider
    DataSet = Query_Eventos
    UpdateMode = upWhereChanged
    Left = 859
    Top = 254
  end
  object ppLista: TppReport
    AutoStop = False
  ...
  object Query_Lista: TADOQuery
    ...
    SQL.Strings = (
      ...
      'Select * from BomixBI.dbo.Fat_VW_ClienteContato_Totvs  '
      'where BMX_TB_ClienteContato.Abrafati = '#39'Sim'#39
      'Order By Gerente, RazaoSocial, Contato')
    Left = 776
    Top = 337
    object Query_ListaCliente_ID: TStringField
      FieldName = 'Cliente_ID'
      ReadOnly = True
      Size = 6
    end
    object Query_ListaRazaoSocial: TStringField
      FieldName = 'RazaoSocial'
      ReadOnly = True
      Size = 40
    end
    object Query_ListaEndereco: TStringField
      FieldName = 'Endereco'
      ReadOnly = True
      Size = 72
    end
    object Query_ListaCidade: TStringField
      FieldName = 'Cidade'
      ReadOnly = True
      Size = 65
    end
    object Query_ListaCEP: TStringField
      FieldName = 'CEP'
      Size = 8
    end
    object Query_ListaContato_ID: TStringField
      FieldName = 'Contato_ID'
      Size = 6
    end
    object Query_ListaContato: TStringField
      FieldName = 'Contato'
      ReadOnly = True
      Size = 86
    end
    object Query_ListaAbrafati: TStringField
      FieldName = 'Abrafati'
      ReadOnly = True
      Size = 3
    end
    object Query_ListaFispal: TStringField
      FieldName = 'Fispal'
      ReadOnly = True
      Size = 3
    end
    object Query_ListaGerente: TStringField
      FieldName = 'Gerente'
      Size = 40
    end
  end
  ...
  object CDS_Lista: TClientDataSet
    ...
    IndexDefs = <>
    Params = <>
    ProviderName = 'DSP_Lista'
    StoreDefs = True
    Left = 837
    Top = 337
    object CDS_ListaCliente_ID: TStringField
      FieldName = 'Cliente_ID'
      ReadOnly = True
      Size = 6
    end
    object CDS_ListaRazaoSocial: TStringField
      FieldName = 'RazaoSocial'
      ReadOnly = True
      Size = 40
    end
    object CDS_ListaEndereco: TStringField
      FieldName = 'Endereco'
      ReadOnly = True
      Size = 72
    end
    object CDS_ListaCidade: TStringField
      FieldName = 'Cidade'
      ReadOnly = True
      Size = 65
    end
    object CDS_ListaCEP: TStringField
      FieldName = 'CEP'
      Size = 8
    end
    object CDS_ListaContato_ID: TStringField
      FieldName = 'Contato_ID'
      Size = 6
    end
    object CDS_ListaContato: TStringField
      FieldName = 'Contato'
      ReadOnly = True
      Size = 86
    end
    object CDS_ListaAbrafati: TStringField
      FieldName = 'Abrafati'
      ReadOnly = True
      Size = 3
    end
    object CDS_ListaFispal: TStringField
      FieldName = 'Fispal'
      ReadOnly = True
      Size = 3
    end
    object CDS_ListaGerente: TStringField
      FieldName = 'Gerente'
      Size = 40
    end
  end
  object DSP_Lista: TDataSetProvider
    DataSet = Query_Lista
    UpdateMode = upWhereChanged
    Left = 868
    Top = 337
  end
  object ppEtiquetaEvento2: TppReport
    AutoStop = False
    Columns = 2
    ...
    Template.FileName = 'C:\Bomix\ETIQUETA.rtm'
    Units = utMillimeters
    ArchiveFileName = '($MyDocuments)\ReportArchive.raf'
    DeviceType = 'Screen'
    DefaultFileDeviceType = 'PDF'
    ...
    Top = 125
    Version = '15.04'
    mmColumnWidth = 104500
    DataPipelineName = 'ppDBPipeline1'
    object ppEtiquetaColumnHeaderBand1: TppColumnHeaderBand
      Background.Brush.Style = bsClear
      mmBottomOffset = 0
      mmHeight = 0
      mmPrintPosition = 0
    ...
    object ppEtiquetaColumnFooterBand1: TppColumnFooterBand
      AlignToBottom = True
      Background.Brush.Style = bsClear
      mmBottomOffset = 0
      mmHeight = 0
  ...
  object ppEtiquetaEvento: TppReport
    AutoStop = False
    Columns = 2
    ColumnPositions.Strings = (
      '4000'
