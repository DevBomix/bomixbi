object BI_PedidoVenda_ItensPedidosxEstoque: TBI_PedidoVenda_ItensPedidosxEstoque
  Left = 0
  Top = 0
  Caption = 'BI_PedidoVenda_ItensPedidosxEstoque'
  ClientHeight = 160
  ClientWidth = 415
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object DSP_RelItensXEstoque: TDataSetProvider
    DataSet = Query_RelItensXEstoque
    Constraints = False
    Left = 280
    Top = 43
  end
  object DS_RelItensXEstoque: TDataSource
    DataSet = CDS_RelItensXEstoque
    Left = 244
    Top = 43
  end
  object Query_RelItensXEstoque: TADOQuery
    ...
    SQL.Strings = (
      ' Select '
        ...
        '       TipoProduto, Grupo, Produto_ID, Produto, Arte_ID, Arte, S' +
        'tatusArte, Sum(Saldo) as Quantidade, Estoque, EstoqueE2 '
      '  from ( '
      ' '
      ' Select * from ('
      ' Select Distinct  '
      ...
      ' Where PV.Empresa = '#39'0101'#39
        ...
        ' AND PV.Emissao Between CONVERT(Datetime,Convert(Varchar(10),'#39'15' +
        '/09/2015 10:10:49'#39',103),103)'
      
        ' AND CONVERT(Datetime,Convert(Varchar(10),'#39'15/09/2015 10:10:49'#39',' +
        '103),103)'
      
        '  AND UF in ('#39'AC'#39','#39'AL'#39','#39'AM'#39','#39'AP'#39','#39'BA'#39','#39'CE'#39','#39'DF'#39','#39'ES'#39','#39'EX'#39','#39'GO'#39','#39 +
        'MA'#39','#39'MG'#39','#39'MS'#39','#39'MT'#39','#39'PA'#39','#39'PB'#39','#39'PE'#39','#39'PI'#39','#39'PR'#39','#39'RJ'#39','#39'RN'#39','#39'RO'#39','#39'RS'#39',' +
        #39'SC'#39','#39'SE'#39','#39'SP'#39','#39'TO'#39')  AND PV.Status in ('#39#39','#39'ABERTO'#39','#39'LIBERADO'#39','#39 +
        'PARCIAL'#39') AND '#9'(PV.Status + PedidoVenda_ID + PV.Cliente_ID + PV.' +
        'Cliente + Cidade + UF + Estado + '
      ...
      '  ) TB  '
        ...
        '  Group by TipoProduto, Grupo, Produto_ID, Produto, Arte_ID, Art' +
        'e, StatusArte, Estoque, EstoqueE2  '
      '  Order by TipoProduto, EstoqueE2 desc  ')
    Left = 212
    Top = 43
    object Query_RelItensXEstoqueTipoProduto: TStringField
      FieldName = 'TipoProduto'
      Size = 15
    end
    object Query_RelItensXEstoqueGrupo: TStringField
      FieldName = 'Grupo'
      Size = 50
    end
    object Query_RelItensXEstoqueProduto_ID: TStringField
      FieldName = 'Produto_ID'
      Size = 10
    end
    object Query_RelItensXEstoqueProduto: TStringField
      FieldName = 'Produto'
      Size = 100
    end
    object Query_RelItensXEstoqueArte_ID: TStringField
      FieldName = 'Arte_ID'
      Size = 12
    end
    object Query_RelItensXEstoqueArte: TStringField
      FieldName = 'Arte'
      Size = 100
    end
    object Query_RelItensXEstoqueStatusArte: TStringField
      FieldName = 'StatusArte'
      Size = 30
    end
    object Query_RelItensXEstoqueQuantidade: TIntegerField
      FieldName = 'Quantidade'
      ReadOnly = True
    end
    object Query_RelItensXEstoqueEstoque: TFloatField
      FieldName = 'Estoque'
      ReadOnly = True
    end
    object Query_RelItensXEstoqueEstoqueE2: TFloatField
      FieldName = 'EstoqueE2'
      ReadOnly = True
    end
  end
  object CDS_RelItensXEstoque: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DSP_RelItensXEstoque'
    Left = 176
    Top = 43
    object CDS_RelItensXEstoqueTipoProduto: TStringField
      FieldName = 'TipoProduto'
      Size = 15
    end
    object CDS_RelItensXEstoqueGrupo: TStringField
      FieldName = 'Grupo'
      Size = 50
    end
    object CDS_RelItensXEstoqueProduto_ID: TStringField
      FieldName = 'Produto_ID'
      Size = 10
    end
    object CDS_RelItensXEstoqueProduto: TStringField
      FieldName = 'Produto'
      Size = 100
    end
    object CDS_RelItensXEstoqueArte_ID: TStringField
      FieldName = 'Arte_ID'
      Size = 12
    end
    object CDS_RelItensXEstoqueArte: TStringField
      FieldName = 'Arte'
      Size = 100
    end
    object CDS_RelItensXEstoqueStatusArte: TStringField
      FieldName = 'StatusArte'
      Size = 30
    end
    object CDS_RelItensXEstoqueQuantidade: TIntegerField
      FieldName = 'Quantidade'
      ReadOnly = True
    end
    object CDS_RelItensXEstoqueEstoque: TFloatField
      FieldName = 'Estoque'
      ReadOnly = True
    end
    object CDS_RelItensXEstoqueEstoqueE2: TFloatField
      FieldName = 'EstoqueE2'
      ReadOnly = True
    end
  end
  object ppReportRelItensXEstoque: TppReport
    AutoStop = False
    ...
    XLSSettings.DefaultBands = [btTitle, btColumnHeader, btDetail]
    ...
    object ppHeaderBand5: TppHeaderBand
      ...
      object ppLabel60: TppLabel
        ...
        HyperlinkEnabled = False
        Border.mmPadding = 0
        Caption = 'Itens de Venda x Estoque'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 18
  ...
  object ppDBPipeline3: TppDBPipeline
    DataSource = DS_RelItensXEstoque
