...
begin
   ...
   if BI_PedidoVenda.CBX_TipoData.Text = 'EMISSÃO' then
       VLC_Select := 'Exec BomixBI.[dbo].[Fat_SP_AtualizarBase_PedidoVenda_ConsultarInsumos] ' + ''''  + VLC_Empresa + '''' + ',' + ''''  + VLC_DataInicial + '''' + ',' + ''''  + VLC_DataFim + '''' + ',' + ''''  + VLC_Buscador + '''' + ',' + ''''  + VLC_Buscador2 + '''';
   ...
   if BI_PedidoVenda.CBX_TipoData.Text = 'PCP' then
       VLC_Select := 'Exec BomixBI.[dbo].[Fat_SP_AtualizarBase_PedidoVenda_ConsultarInsumos_DataPCP] ' + ''''  + VLC_Empresa + '''' + ',' + ''''  + VLC_DataInicial + '''' + ',' + ''''  + VLC_DataFim + '''' + ',' + ''''  + VLC_Buscador + '''' + ',' + ''''  + VLC_Buscador2 + '''';
