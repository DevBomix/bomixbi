object BI_PedidoVenda_ItensSemVendas: TBI_PedidoVenda_ItensSemVendas
  Left = 0
  Top = 0
  Caption = 'BI_PedidoVenda_ItensSemVendas'
  ClientHeight = 149
  ClientWidth = 481
  Color = clBtnFace
  ...
  object ppReport: TppReport
    ...
    object ppHeaderBand5: TppHeaderBand
      ...
      object ppLabel60: TppLabel
        ...
        HyperlinkEnabled = False
        Border.mmPadding = 0
        Caption = 'Itens de Estoque Sem Vendas'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 18
  ...
  object CDS: TClientDataSet
    ...
    object CDSEstoqueE2: TFloatField
      FieldName = 'EstoqueE2'
      ReadOnly = True
    end
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      ...
      'Select '#9
        ...
        #9'Bloqueado, Empresa, TipoProduto, Grupo, Produto_ID, Produto, Es' +
        'toqueE2, Sum(Saldo) as Estoque'#9
      'from ('
      #9'  '
      'Select '
      
        #9'Bloqueado, Empresa, Grupo, Produto_ID, Produto, TipoProduto, B2' +
        '_Saldo as Saldo,'
      
        #9'Isnull((Select SUM(B2_Saldo) from BomixBI.dbo.Est_TB_EstoqueMap' +
        'eamento E2 (nolock)'#9
      
        #9'Where E2.Armazem = '#39'E2'#39' AND E2.Empresa = Estoque.Empresa AND E2' +
        '.Produto_ID = Estoque.Produto_ID),0) as EstoqueE2 '
      'from BomixBI.dbo.Est_TB_EstoqueMapeamento Estoque (nolock)'
      'Where B2_Saldo > 0'
      'AND TipoProduto in ('#39'TAMPA'#39','#39'BALDE'#39')'
      'AND Empresa = '#39'0101'#39
      'AND Produto_ID not in ('
      ''
      #9#9'Select Distinct Produto_ID from ('
      #9#9
      #9#9
      #9#9' Select Distinct  '
      #9#9' Isnull((Select top 1 '
      
        #9#9#9'OP.OrdemProducao from BomixBI.dbo.Pcp_TB_OrdemProducao OP (no' +
        'lock) '
      #9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9'Where OP.Pedido = Item.Pedido_FK '
      #9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9'AND OP.Empresa = Item.C6_Empresa  '
      #9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9'AND OP.Produto_ID = Item.Produto_ID '
      #9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9'AND OP.Sequencia = Item.Sequencia '
      #9#9#9'Order by OP.Emissao desc  '
      #9#9'),'#39#39') as OP, '
      
        #9#9'  Status, PedidoVenda_ID, Emissao, Dia, Ano, Mes, TipoDocument' +
        'o, Cliente_ID, Cliente, '
      
        #9#9#9'Loja, Endereco, Bairro, CEP, Cidade, UF, Estado, Segmento, Te' +
        'lefone, Email, '
      
        #9#9#9'Contato, flgTemGrupoCliente, GrupoCliente_FK, GrupoCliente, V' +
        'endedor_FK, '
      
        #9#9#9'Vendedor, Gerencia_FK, Gerente, Transportadora_FK, Transporta' +
        'dora, TransportadoraRedespacho_FK, '
      
        #9#9#9'TransportadoraRedespacho, DataPCP, Responsavel, RespData, Pen' +
        'dencia, Empresa, Recno '
      #9#9'  , Item.*, '
      
        #9#9' (Select SUM(B2_Saldo) from BomixBI.dbo.Est_TB_EstoqueMapeamen' +
        'to (nolock) where Empresa = Item.C6_Empresa AND Produto_ID = Ite' +
        'm.Produto_ID) as Estoque, '
      
        #9#9' (Select SUM(B2_Saldo) from BomixBI.dbo.Est_TB_EstoqueMapeamen' +
        'to (nolock) '
      
        #9#9'  Where Armazem = '#39'E2'#39' AND Empresa = Item.C6_Empresa AND Produ' +
        'to_ID = Item.Produto_ID) as EstoqueE2, '
      
        #9#9'  Isnull((Select Top 1 PedidoVenda_FK from BomixBI.dbo.Fat_TB_' +
        'PedidoVendaCarregamento (nolock) where Empresa = PV.Empresa AND ' +
        'PedidoVenda_FK = PV.PedidoVenda_ID),'#39#39') as OrdemCarregamento '
      #9#9' from BomixBI.dbo.Fat_TB_PedidoVenda (nolock) PV'
      
        #9#9' Inner Join BomixBI.dbo.Fat_TB_PedidoVendaItem (nolock) Item O' +
        'n Item.Pedido_FK = PV.PedidoVenda_ID '
      #9#9#9#9#9#9#9#9#9#9#9#9#9'AND Item.C6_Empresa = PV.Empresa '
      #9#9' Where PV.Empresa = '#39'0101'#39
      
        #9#9' AND PV.Emissao Between CONVERT(Datetime,Convert(Varchar(10),'#39 +
        '12/09/2015 10:10:49'#39',103),103)'
      
        #9#9' AND CONVERT(Datetime,Convert(Varchar(10),'#39'17/09/2015 10:10:49' +
        #39',103),103)'
      
        #9#9'  AND UF in ('#39'AC'#39','#39'AL'#39','#39'AM'#39','#39'AP'#39','#39'BA'#39','#39'CE'#39','#39'DF'#39','#39'ES'#39','#39'EX'#39','#39'GO'#39 +
        ','#39'MA'#39','#39'MG'#39','#39'MS'#39','#39'MT'#39','#39'PA'#39','#39'PB'#39','#39'PE'#39','#39'PI'#39','#39'PR'#39','#39'RJ'#39','#39'RN'#39','#39'RO'#39','#39'RS' +
        #39','#39'SC'#39','#39'SE'#39','#39'SP'#39','#39'TO'#39')  AND PV.Status in ('#39#39','#39'ABERTO'#39','#39'LIBERADO'#39 +
        ','#39'PARCIAL'#39') AND '#9'(PV.Status + PedidoVenda_ID + PV.Cliente_ID + P' +
        'V.Cliente + Cidade + UF + Estado + '
      
        #9#9' Segmento + Vendedor_FK + Vendedor + Gerencia_FK + Gerente + I' +
        'snull(Transportadora,'#39#39')'
      
        #9#9' + Item.Produto_ID + Item.Grupo + Item.Produto + Item.TipoProd' +
        'uto + Tamanho + Item.StatusArte + TES + Pendencia '
      #9#9' + Isnull((Select top 1 '
      ...
      #9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9'AND OP.Produto_ID = Item.Produto_ID '
      #9#9#9#9#9#9#9#9#9#9#9#9#9#9#9#9'AND OP.Sequencia = Item.Sequencia '
      #9#9#9'Order by OP.Emissao desc),'#39#39'))'
      #9#9' Like '#39'%%'#39
      #9#9
      #9#9
      #9#9
      ...
      ''
        ...
        'Group by Bloqueado, Empresa, TipoProduto, Grupo, Produto_ID, Pro' +
        'duto, EstoqueE2'
      'Order by TipoProduto, Grupo'
      ''
      ''
      '')
    Left = 220
    ...
    object QueryEstoqueE2: TFloatField
      FieldName = 'EstoqueE2'
      ReadOnly = True
    end
