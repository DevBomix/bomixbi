inherited DiarioTransportadora: TDiarioTransportadora
  BorderStyle = bsSingle
  Caption = 'Di'#225'rio de Nota Fiscal por Transportadora'
  ClientHeight = 665
  ClientWidth = 1135
  ...
  inherited PNL_Auxiliar: TPanel
    ...
    inherited Panel_Filtro: TPanel
      ...
      object DT_DataEmissao: TDateTimePicker
        Left = 944
        Top = 4
        Width = 160
        Height = 37
        Date = 41275.424179409730000000
        Time = 41275.424179409730000000
  ...
  inherited Panel_Botoes: TPanel
    ...
    ExplicitWidth = 1135
    ExplicitHeight = 155
    object BNT_CorrigirErros: TSpeedButton [0]
      Left = 376
      Top = 1
      Width = 68
      Height = 41
  ...
  inherited CDS: TClientDataSet
    ...
    object CDSAF: TStringField
      FieldName = 'AF'
      ReadOnly = True
      Size = 6
    end
    object CDSCanhoto: TStringField
      FieldName = 'Canhoto'
      Size = 9
    end
  ...
  inherited Query: TADOQuery
    SQL.Strings = (
      ...
      'Select  top 50'
        ...
        #9'Nota.Emissao, Nota, Cliente_ID, Cliente, Cidade, UF, Transporta' +
        'dora_FK, Nota.Transportadora, '
      
        #9'Case When AF is null then '#39#39' else AF end as AF, Item.Nota_FK as' +
        ' Canhoto, Observacao,'
      
        #9'(Nota + Cliente_ID + Cliente + Cidade + UF +  Nota.Transportado' +
        'ra) as Buscador'
      #9
      'from BomixBI.dbo.Fat_TB_NotaFiscalVenda Nota (nolock) '
      
        'Left join BomixBI.dbo.Fat_VW_PedidoCompraTransportadoraAF_Totvs ' +
        'PedidoCompraTransportadoraAF ON Transportadora_ID = Transportado' +
        'ra_FK AND Observacao like '#39'%'#39' + Substring(Nota,4,7)+ '#39'%'#39
      
        'Left Join BomixBI.dbo.Fat_TB_NotaFiscalCompraItem Item On Item.P' +
        'edido = PedidoCompraTransportadoraAF.AF'
      'Where ComissaoVendedor = '#39'Soma'#39
      'AND Nota.Emissao = '#39'2014-02-03 00:00:00.000'#39
      'AND Nota.Transportadora <> '#39'O MESMO'#39
      'Order by Nota.Emissao desc, Nota.Transportadora, Cliente')
    ...
    object QueryAF: TStringField
      FieldName = 'AF'
      ReadOnly = True
      Size = 6
    end
    object QueryCanhoto: TStringField
      FieldName = 'Canhoto'
      Size = 9
    end
  ...
  object CDS_Impressao: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DSP_Impressao'
    Left = 328
    Top = 288
    object CDS_ImpressaoEmissao: TDateTimeField
      FieldName = 'Emissao'
      ReadOnly = True
    end
    object CDS_ImpressaoNota: TStringField
      FieldName = 'Nota'
      Size = 9
    end
    object CDS_ImpressaoCliente_ID: TStringField
      FieldName = 'Cliente_ID'
      ReadOnly = True
      Size = 6
    end
    object CDS_ImpressaoCliente: TStringField
      FieldName = 'Cliente'
      ReadOnly = True
      Size = 40
    end
    object CDS_ImpressaoCidade: TStringField
      FieldName = 'Cidade'
      ReadOnly = True
      Size = 60
    end
    object CDS_ImpressaoUF: TStringField
      FieldName = 'UF'
      ReadOnly = True
      Size = 2
    end
    object CDS_ImpressaoTransportadora_FK: TStringField
      FieldName = 'Transportadora_FK'
      Size = 6
    end
    object CDS_ImpressaoTransportadora: TStringField
      FieldName = 'Transportadora'
      ReadOnly = True
      Size = 40
    end
    object CDS_ImpressaoAF: TStringField
      FieldName = 'AF'
      ReadOnly = True
      Size = 6
    end
    object CDS_ImpressaoCanhoto: TStringField
      FieldName = 'Canhoto'
      Size = 9
    end
    object CDS_ImpressaoObservacao: TStringField
      FieldName = 'Observacao'
      Size = 250
    end
    object CDS_ImpressaoBuscador: TStringField
      FieldName = 'Buscador'
      ReadOnly = True
      Size = 157
    end
  end
  object Query_Impressao: TADOQuery
    ...
    Left = 364
    Top = 288
    object Query_ImpressaoEmissao: TDateTimeField
      FieldName = 'Emissao'
      ReadOnly = True
    end
    object Query_ImpressaoNota: TStringField
      FieldName = 'Nota'
      Size = 9
    end
    object Query_ImpressaoCliente_ID: TStringField
      FieldName = 'Cliente_ID'
      ReadOnly = True
      Size = 6
    end
    object Query_ImpressaoCliente: TStringField
      FieldName = 'Cliente'
      ReadOnly = True
      Size = 40
    end
    object Query_ImpressaoCidade: TStringField
      FieldName = 'Cidade'
      ReadOnly = True
      Size = 60
    end
    object Query_ImpressaoUF: TStringField
      FieldName = 'UF'
      ReadOnly = True
      Size = 2
    end
    object Query_ImpressaoTransportadora_FK: TStringField
      FieldName = 'Transportadora_FK'
      Size = 6
    end
    object Query_ImpressaoTransportadora: TStringField
      FieldName = 'Transportadora'
      ReadOnly = True
      Size = 40
    end
    object Query_ImpressaoAF: TStringField
      FieldName = 'AF'
      ReadOnly = True
      Size = 6
    end
    object Query_ImpressaoCanhoto: TStringField
      FieldName = 'Canhoto'
      Size = 9
    end
    object Query_ImpressaoObservacao: TStringField
      FieldName = 'Observacao'
      Size = 250
    end
    object Query_ImpressaoBuscador: TStringField
      FieldName = 'Buscador'
      ReadOnly = True
      Size = 157
    end
  ...
  object DS_Impressao: TDataSource
    DataSet = CDS_Impressao
    Left = 400
    Top = 288
  end
  object DSP_Impressao: TDataSetProvider
    DataSet = Query_Impressao
    Left = 434
    Top = 288
  end
end
