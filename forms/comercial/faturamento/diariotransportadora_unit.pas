...
begin
  ...
  begin
       Application.MessageBox('Nenhum registro encontrado para Impressão','Atenção',mb_iconwarning + mb_ok);
       Exit;
  end;
  ...
  ppLBL_Data.Caption := 'Impressão às: ' + DateTimeToStr(Date()) + '  por ' + Sys_FuncaoSistema.PNL_UsuarioAtivo.Caption;
  ppImpressao.Print;
