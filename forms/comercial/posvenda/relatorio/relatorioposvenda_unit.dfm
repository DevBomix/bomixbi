inherited RelatorioPosVenda: TRelatorioPosVenda
  Caption = 'Relat'#243'rio de P'#243's Venda'
  ClientHeight = 222
  ClientWidth = 686
  OnShow = FormShow
  ExplicitWidth = 692
  ...
  object Panel7: TPanel [4]
    ...
    object DT_DataEntrega1: TDateTimePicker
      ...
      ParentFont = False
      TabOrder = 5
      OnExit = DT_DataEntrega1Exit
    end
    object DT_DataEntrega2: TDateTimePicker
      Left = 496
      Top = 4
      Width = 158
      Height = 24
  ...
  object Panel4: TPanel [5]
    ...
    object CBX_TipoPedido: TComboBox
      ...
      ParentFont = False
      TabOrder = 1
      Text = 'P'#211'S VENDA - POR TRANSPORTADORA'
      OnChange = CBX_TipoPedidoChange
      Items.Strings = (
        'P'#211'S VENDA - POR TRANSPORTADORA'
        'P'#211'S VENDA - POR CLASSIFICA'#199#195'O DE ENTREGA')
    end
  end
  ...
  object DSP_PosVenda: TDataSetProvider
    DataSet = Query_PosVenda
    UpdateMode = upWhereChanged
    Left = 347
    Top = 178
  end
  object CDS_PosVenda: TClientDataSet
    Aggregates = <>
    FieldDefs = <
      item
        Name = 'ID'
    ...
    IndexDefs = <>
    Params = <>
    ProviderName = 'DSP_PosVenda'
    StoreDefs = True
    Left = 316
    Top = 178
    object CDS_PosVendaID: TStringField
      FieldName = 'ID'
      ReadOnly = True
      Size = 6
    end
    object CDS_PosVendaTransportadora: TStringField
      FieldName = 'Transportadora'
      ReadOnly = True
      Size = 40
    end
    object CDS_PosVendaEntrega: TStringField
      FieldName = 'Entrega'
      ReadOnly = True
      Size = 27
    end
    object CDS_PosVendaNota: TIntegerField
      FieldName = 'Nota'
      ReadOnly = True
    end
  end
  object DS_PosVenda: TDataSource
    DataSet = CDS_PosVenda
    Left = 285
    Top = 178
  end
  object Query_PosVenda: TADOQuery
    ...
    SQL.Strings = (
      'Select '
        ...
        #9'Transportadora_id as ID, Transportadora, Entrega, COUNT(Nota) a' +
        's Nota'
      'from ('
      #9'Select Transportadora_id, Transportadora, Entrega, Nota'
      #9'from BomixBI.dbo.Fat_VW_NotaFiscalVendaPos_Totvs (nolock)'
      
        #9'Where DTPosDataConfirmacao between '#39'2013-01-01 00:00:00.000'#39' AN' +
        'D '#39'2013-05-17 23:59:59.000'#39#9
      #9'Union ALL'
      
        #9'Select Transportadora_id, Transportadora, Entrega, Nota from Bo' +
        'mixBI.dbo.Fat_VW_NotaFiscalVendaPos_Totvs (nolock)'
      
        #9'Where CONVERT(Datetime,DTDataPrevista,112) between '#39'2013-01-01 ' +
        '00:00:00.000'#39' AND '#39'2013-05-17 23:59:59.000'#39
      #9'AND Entrega = '#39'N'#195'O REALIZADA'#39' AND PosReligar = '#39'F'#39#9
      #9'Union ALL'
      
        #9'Select Transportadora_id, Transportadora, '#39'CONTACTADOS POREM SE' +
        'M EXITO'#39' as Entrega, Nota from BomixBI.dbo.Fat_VW_NotaFiscalVend' +
        'aPos_Totvs (nolock)'
      
        #9'Where CONVERT(Datetime,DTDataPrevista,112) between '#39'2013-01-01 ' +
        '00:00:00.000'#39' AND '#39'2013-05-17 23:59:59.000'#39
      #9'AND Entrega = '#39'N'#195'O REALIZADA'#39' AND PosReligar = '#39'V'#39#9#9
      ') TB'
      'Group by Transportadora_id, Transportadora, Entrega'
      'Having Transportadora <> '#39'O MESMO'#39
      'AND Transportadora_id = '#39'000005'#39
      'Order by Transportadora_id, Entrega'
      '')
    Left = 256
    Top = 178
    object Query_PosVendaID: TStringField
      FieldName = 'ID'
      ReadOnly = True
      Size = 6
    end
    object Query_PosVendaTransportadora: TStringField
      FieldName = 'Transportadora'
      ReadOnly = True
      Size = 40
    end
    object Query_PosVendaEntrega: TStringField
      FieldName = 'Entrega'
      ReadOnly = True
      Size = 27
    end
    object Query_PosVendaNota: TIntegerField
      FieldName = 'Nota'
      ReadOnly = True
    end
  end
  object ppPosVendaTransportadora: TppReport
    AutoStop = False
    DataPipeline = ppDBPipeline1PosVenda
    ...
    Version = '19.03'
    mmColumnWidth = 98651
    DataPipelineName = 'ppDBPipeline1PosVenda'
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLBL_TituloRelatorio: TppLabel
        ...
        Border.mmPadding = 0
        Caption = 'Relat'#243'rio de P'#243's Venda - Por Transportadora'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 20
  ...
  object ppDBPipeline1PosVenda: TppDBPipeline
    DataSource = DS_PosVenda
    CloseDataSource = True
    UserName = 'DBPipeline1PosVenda'
    Left = 192
    Top = 178
    object ppDBPipeline1PosVendappField1: TppField
      FieldAlias = 'ID'
      FieldName = 'ID'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBPipeline1PosVendappField2: TppField
    ...
    object ppDBPipeline1PosVendappField3: TppField
      FieldAlias = 'Entrega'
      FieldName = 'Entrega'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppDBPipeline1PosVendappField4: TppField
      FieldAlias = 'Nota'
      FieldName = 'Nota'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object ppPosVendaEntrega: TppReport
    AutoStop = False
    DataPipeline = ppDBPipeline1PosVenda
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    ...
    object ppHeaderBand2: TppHeaderBand
      ...
      object ppLabel5: TppLabel
        ...
        HyperlinkEnabled = False
        Border.mmPadding = 0
        Caption = 'Relat'#243'rio de P'#243's Venda - Por Classifica'#231#227'o de Entrega'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 20
    ...
    object ppGroup2: TppGroup
      ...
      object ppGroupHeaderBand2: TppGroupHeaderBand
        ...
        object ppLabel9: TppLabel
          ...
          AutoSize = False
          Border.mmPadding = 0
          Caption = 'CLASSIFICA'#199#195'O DE ENTREGA'
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Name = 'Arial'
          Font.Size = 10
