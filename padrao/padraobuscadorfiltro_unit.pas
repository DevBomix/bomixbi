...
// *****************************************************************************************************************************
// Data: 19/11/2009
// Desenvolvedor: André Brito
// Função: Rotina para que quando o Campo 2 precisar ser visivel, se ajuste conforme o tamanho do Campo 1
// Exemplo: Operador Entre: ambos os campos estarão visivel e seu tamanho é definido conforme variavel TamanhoOriginal. Já para
// outros Operadores o Campo 1 é o dobro desta varivel somando mais 1.
// *****************************************************************************************************************************
...
begin
  ...
  If (Operador.Text = 'Iniciado por') or (Operador.Text = 'Igual') or (Operador.Text = 'Terminado por')
     or (Operador.Text = 'Contém') or (Operador.Text = 'Está contido')then
  begin
...
// Data: 19/11/2009
// Função: Quando o Usuário selecionar o Panel de Polaridade, deverá pintar de Azul para Positivo e Vermelho para Negativo.
// Exemplo: Operador Igual com Negativo ficará <> (Diferente).
// *****************************************************************************************************************************
...
// Data: 19/11/2009
// Função: Trata as opções dos Filtros confirmadas pelo usuário. Aonde se um Valor for vazio, o operador é automaticamente
...
begin
  ...
  begin
       ...
       If Operador.Text = 'Está contido' then
          begin
              If Painel.Color = clAqua then
              begin
                  If TipoInformacao = 'Caracter' then
