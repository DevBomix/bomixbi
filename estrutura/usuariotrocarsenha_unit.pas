...
// VALIDAÇÃO ****************************************************************************************************************
// **************************************************************************************************************************
  If TXT_SenhaAtual.Text <> Sys_FuncaoSistema.PNL_UsuarioSenha.Caption then
  begin
...
// GRAVAR A NOVA SENHA *****************************************************************************************************
  ...
  VLC_Update :=   VLC_Update + ' Where Login = ' + '''' + TXT_Login.Text + '''';
  ...
  Sys_FuncaoSistema.PNL_UsuarioSenha.Caption := TXT_SenhaConfirmar.Text;
