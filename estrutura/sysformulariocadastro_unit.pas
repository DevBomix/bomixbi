...
// Validação **********************************************************************************************************
  ...
  begin
       Application.MessageBox('Campo Obrigatório: Defina o nome do Modulo!' + #13 + '','Atenção',mb_iconerror + mb_ok);
       CBX_Modulo.SetFocus;
       Exit;
  end;
 ...
 // ******************************************************************************************************************
  ...
  begin
      ...
      begin
         Application.MessageBox('Campo em Duplicidade. Defina outro nome para o Formulário!' + #13 + '','Atenção',mb_iconerror + mb_ok);
         TXT_Descricao.SetFocus;
         Exit;
      end;
...
begin
  ...
  try
      ...
      begin
        Application.MessageBox('Todos os sistemas já estão vinculados a este formulário!' + #13 + '','Atenção',mb_iconerror + mb_ok);
        Exit;
      end;
