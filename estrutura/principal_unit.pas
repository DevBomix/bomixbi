...
begin
  ...
  begin
    Application.MessageBox('Acesso negado para consultar Setor.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(25,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para consultar Usuário.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If (Sys_FuncaoSistema.GetVerificaSeExistePermissao(155,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False) then
  begin
    Application.MessageBox('Acesso negado para Administração de Ciclo' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
...
begin
  ...
  If (Sys_FuncaoSistema.GetVerificaSeExistePermissao(135,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False) then
  begin
    Application.MessageBox('Acesso negado para Administração de Master e Resina.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(126,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Imprimir Relatório de Apontamento de Paletização.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
  begin
    ...
    try
      ...
      begin
        ...
        CBX_Tipo.Text := 'APONTAMENTOS PALETIZAÇÃO - ANALÍTICO';
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Correção de Apontamento.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(56,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para consultar Acessso ao Usuário.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(53,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Imprimir Relatório de Injeção.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
  begin
    ...
    try
      ...
      begin
        ...
        CBX_Tipo.Text := 'APONTAMENTOS DE PRODUÇÃO - ANALÍTICO';
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Imprimir Relatório de Horas Improdutivas.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  begin
      ...
      Application.MessageBox('Acesso negado para Imprimir Ordem de Produção.' +
        #13 + 'Consulte o Administrador do sistema', 'Atenção',
        mb_iconwarning + mb_ok);
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(72,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Ordem de Produção (PCP)' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
    ...
    try
      ...
      // O Tamanho da Categoria será conforme o Numero de Itens que o Usuário tem acesso
      BI_PCP.CategoryPanel2.Height := 34 + (Sys_FuncaoSistema.CBX_PermissaoSetoresProducoes.Items.Count * 38);

      // Listar Permissões de Setores da Produção para só habilitar os botões conforme o Usuário Logado
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Ordem de Solicitação de Matéria Prima.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(77,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Imprimir Relatório de Perdas.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Relatorio de Posição de Estoque x Faturamento.' + #13
      + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(12,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para cadastrar Formulário.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(8,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para consultar Grupo de Usuário.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Imprimir Relatório de Controle de Rotúlos.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Imprimir Relatório de Diária de Transportadora.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(58,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para consultar Especificação Técnica.'
      + #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Configuração de Molde' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(145,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para consultar Peça Padrão.'
      + #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(132,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para consultar Processo de Inspeção.'
      + #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Imprimir Relatório de Mapa Anual de Vendas.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Imprimir Relatório de Média de Prazo de Pagamento.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Periódico de Faturamento x Produção.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(39,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Pós Venda.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(76,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Relação de Nota Fiscal de Venda.'
      + #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(43,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Relatório de CIT.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(44,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Relatório de Pós Venda.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(47,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Relatório de Mix de Produtos.' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Relatorio de Posição de Estoque.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Transferência Produção WMS -> Protheus.' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Último Faturamento do Cliente).' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Último Faturamento do Produto).' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Tonelagem Diária).' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(141,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Solicitação de Cadastro de Produto' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  begin
    Application.MessageBox
      ('Acesso negado para Imprimir Relatório Comparativo Vendas Anuais .' +
      #13 + 'Consulte o Administrador do sistema', 'Atenção',
      mb_iconwarning + mb_ok);
  end
  else
...
begin
  ...
  if Item.Caption = '&PCP / Produção' then
  begin
    ...
    PNL_MenuGestaoPessoal.Visible := False;
    PNL_MenuPainelControle.Visible := False;
    LBL_Modulo.Caption := 'PCP / Produção';
    Exit;
  end;

  if Item.Caption = '&Gestão Pessoal' then
  begin
    PNL_MenuComercial.Visible := False;
    PNL_MenuProducaoPCP.Visible := False;
    PNL_MenuQualidade.Visible := False;
    ...
    PNL_MenuPainelControle.Visible := False;
    LBL_Modulo.Caption := 'Gestão Pessoal';
    Exit;
  end;
...
begin
  ...
  If Sys_FuncaoSistema.GetVerificaSeExistePermissao(99,
    Sys_FuncaoSistema.PNL_LoginAtivo.Caption) = False then
  begin
    Application.MessageBox('Acesso negado para Crachá de Colaboradores' + #13 +
      'Consulte o Administrador do sistema', 'Atenção', mb_iconwarning + mb_ok);
  end
  else
  begin
...
begin
  ...
  Sys_Principal.LBL_VersaoSistema.Caption := ('  Versão do Sistema: ' + Sys_FuncaoSistema.PNL_VersaoRegistrada.Caption + '  -  Data da Última Atualização: ' + VLC_UltimaAtualizacao + '  -  Computador: ' + VLC_NomeComputador);
...
begin
  ...
  if PNL_UsuarioAtivoPrincipal.Caption <> 'Usuário Logado' then
  begin
    VLC_NomeComputador := Sys_FuncaoSistema.GetNomeComputador;
    VLC_NomeSistema := Sys_Principal.PNL_Sistema.Caption;
    ...
    Try
         ...
         begin
                ...
                LBL_AtualizarPosicao1.Caption := 'Existe uma nova versão deste sistema na rede.';
                LBL_AtualizarPosicao2.Caption := 'Clique no botão abaixo para iniciar a atualização.';
         ...
         // Versão do Executavel x Banco de Dados
    ...
    Except
      ...
      Application.MessageBox('Conexão com a rede falhou. Sistema será fechado!'
        + #13 + '', 'Atenção', mb_iconerror + mb_ok);
